...
class VisaDocsPending extends Component
{
    /**
    ...
    {
        return view('components.OnboardingReport.visadocspending');
    }
		...
		public static function getTotalDataDXB($dept,$widgetId)
	{
		...
		return DocumentCollectionDetails::select("id")->whereRaw($whereraw)->where("department",$dept)->where("location","DXB")->where("visa_documents_status",1)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->whereIn("visa_process_status",array(0,1))->whereIn("ok_visa",array(1,4))->get()->count();
		}
			
		else
		{
			//echo "h2";
			return DocumentCollectionDetails::select("id")->where("department",$dept)->where("location","DXB")->where("visa_documents_status",1)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->whereIn("visa_process_status",array(0,1))->whereIn("ok_visa",array(1,4))->get()->count();
	...
	public static function getTotalDataAUH($dept,$widgetId)
	{
		...
		if($whereraw != '')
		{
			...
			return DocumentCollectionDetails::select("id")->whereRaw($whereraw)->where("department",$dept)->where("location","AUH")->where("visa_documents_status",1)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->whereIn("visa_process_status",array(0,1))->whereIn("ok_visa",array(1,4))->get()->count();
		 }
			
		else
		{
			//echo "h2";
			return DocumentCollectionDetails::select("id")->where("department",$dept)->where("location","AUH")->where("visa_documents_status",1)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->whereIn("visa_process_status",array(0,1))->whereIn("ok_visa",array(1,4))->get()->count();
		//return DepartmentFormEntry::where("form_id",2)->whereRaw($whereraw)->get()->count();	
