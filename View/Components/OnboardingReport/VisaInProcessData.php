...
class VisaInProcessData extends Component
{
    /**
    ...
    {
        return view('components.OnboardingReport.visainprocess');
    }
		...
		public static function getTotalDataDXB($dept,$widgetId)
	{
		...
		return DocumentCollectionDetails::select("id")->whereRaw($whereraw)->where("department",$dept)->where("location","DXB")->where("visa_process_status",2)->where("backout_status",1)->get()->count();
		}
			
		else
		{
			//echo "h2";
			return DocumentCollectionDetails::select("id")->where("department",$dept)->where("location","DXB")->where("visa_process_status",2)->where("backout_status",1)->get()->count();
	...
	public static function getTotalDataAUH($dept,$widgetId)
	{
		...
		if($whereraw != '')
		{
			...
			return DocumentCollectionDetails::select("id")->whereRaw($whereraw)->where("department",$dept)->where("location","AUH")->where("visa_process_status",2)->where("backout_status",1)->get()->count();
		 }
			
		else
		{
			//echo "h2";
			return DocumentCollectionDetails::select("id")->where("department",$dept)->where("location","AUH")->where("visa_process_status",2)->where("backout_status",1)->get()->count();
		//return DepartmentFormEntry::where("form_id",2)->whereRaw($whereraw)->get()->count();	
