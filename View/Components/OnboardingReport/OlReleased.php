...
class OlReleased extends Component
{
    /**
    ...
    {
        return view('components.OnboardingReport.olreleased');
    }
		...
		public static function getTotalDataDXB($dept,$widgetId)
	{
		...
		{
			//echo "h1";
		return DocumentCollectionDetails::select("id")->whereRaw($whereraw)->where("department",$dept)->where("location","DXB")->where("offer_letter_relased_status",2)->where("offer_letter_onboarding_status",1)->where("backout_status",1)->where("onboard_status",1)->get()->count();
		}
			
		else
		{
			//echo "h2";
			return DocumentCollectionDetails::select("id")->where("department",$dept)->where("location","DXB")->where("offer_letter_relased_status",2)->where("offer_letter_onboarding_status",1)->where("backout_status",1)->where("onboard_status",1)->get()->count();
	...
	public static function getTotalDataAUH($dept,$widgetId)
	{
		...
		{
			//echo "h1";
		return DocumentCollectionDetails::select("id")->whereRaw($whereraw)->where("department",$dept)->where("location","AUH")->where("offer_letter_relased_status",2)->where("offer_letter_onboarding_status",1)->where("backout_status",1)->where("onboard_status",1)->get()->count();
		}
			
		else
		{
			//echo "h2";
			return DocumentCollectionDetails::select("id")->where("department",$dept)->where("location","AUH")->where("offer_letter_relased_status",2)->where("offer_letter_onboarding_status",1)->where("backout_status",1)->where("onboard_status",1)->get()->count();
		//return DepartmentFormEntry::where("form_id",2)->whereRaw($whereraw)->get()->count();	
