...
class PerformanceMashreqCumulativeSubmissions extends Component
{
    /**
    ...
    public function __construct($widgetId)
    {
	   ...
	   $whereraw = '';
		...
		if($whereraw != '')
		{
		$totaldata= DepartmentFormEntry::groupBy('team')->selectRaw('count(*) as total, team')->where("form_id",1)->whereRaw($whereraw)->get();
  ...
  $finaldata= json_encode($finalarray);
    ...
    {
        return view('components.Performance.performancemashreqcumulativesubmissions');
    }
