...
class PerformanceMashreqApprovalRate extends Component
{
    /**
    ...
    {
        return view('components.Performance.performancemashreqapprovalrate');
    }
...
public static function getTotalsubmissionbooking($team,$widgetId)
	{
		...
		return MashreqBookingMIS::whereIn("instanceid",$finalarray)->get()->count();	
		}
		else{
			return 1;
		}
