...
class PerformanceCbdApprovalRate extends Component
{
    /**
    ...
    {
        return view('components.Performance.performancecbdapprovalrate');
    }
...
public static function getTotalsubmissionbooking($team,$widgetId)
	{
		...
		return CBDBankMis::whereRaw($whereraw)->whereIn("Status",array("Missing(Approved)","Welcome Calling,Archive on Approval","Approved","Pending with Onboarder","Pending with COC"))->where("sm_manager",$team)->get()->count();	
