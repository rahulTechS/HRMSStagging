...
class PerformanceScbCumulativeSubmissions extends Component
{
    /**
  ...
  $finaldata= json_encode($finalarray);
    ...
    {
        return view('components.Performance.performancescbcumulativesubmissions');
    }
...
Private function getTeamdata($team,$widgetId)
	{
		...
		if($whereraw != '')
		{
		$totaldata= SCBDepartmentFormParentEntry::groupBy('application_date')->selectRaw('count(*) as total, application_date')->whereRaw($whereraw)->where("team",$team)->get();
