...
class CbdSubmissionsHome extends Component
{
    /**
    ...
    public function __construct($widgetId)
    {
	   ...
	   $whereraw = '';
		...
		if($whereraw != '')
		{
		$totaldata= DepartmentFormEntry::whereIn("emp_id",$finalemp)->whereRaw($whereraw)->where("form_id",2)->groupBy('emp_id')->get();
    ...
    {
        return view('components.SalesManagement.cbdsubmissionshome');
    }
