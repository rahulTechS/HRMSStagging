...
class ReportData extends Component
{
	...
	// 	$empData= Employee_details::where('emp_id',$userData->employee_id)->where('job_function',3)->first();
	   ...
	   $whereraw = '';
		...
		$TeamLists = CBDBankMis::groupBy('sm_manager')->selectRaw('count(*) as total, sm_manager')->get();
    ...
    public function render()
    {
		...
		return view('components.SalesManagement.report-1');
...
public static function getSourceCode($empid)
{
	...
	public static function getBookingCount($empid,$fromfilterdate,$month,$tofilterdate)
	{
		...
		$empbookingdata= CBDBankMis::whereRaw($whererawdefault)->where('employee_id', $empid)->orderBy("id","DESC")->get()->count();		
