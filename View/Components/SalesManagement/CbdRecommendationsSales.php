...
class CbdRecommendationsSales extends Component
{
    /**
	...
	// 	$empData= Employee_details::where('emp_id',$userData->employee_id)->where('job_function',3)->first();
	   ...
	   $whereraw = '';
		...
		$TeamLists = CBDBankMis::groupBy('sm_manager')->selectRaw('count(*) as total, sm_manager')->whereNotNull('sm_manager')->get();
    ...
    public function render()
    {
		...
		return view('components.SalesManagement.cbdrecommendationsales');
