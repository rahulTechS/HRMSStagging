...
class LastMonthCbdCumulativeSubmissionsLeaderShip extends Component
{
    /**
    ...
    {
        return view('components.ComparePreference.cbdcumulativesubmissionslastmonthleadership');
    }
