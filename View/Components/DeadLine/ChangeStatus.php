...
class ChangeStatus extends Component
{
    ...
    public function __construct($widgetId)
    {
	   ...
	   $whereraw = '';
		...
		if($whereraw != '')
				...
				{
					//echo "hello1";
					$documentCollectiondetaildata = DocumentCollectionDetails::whereIn("visa_process_status",array(0,1,2))->where("visa_documents_status",2)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->where("sort_dateBY","Change Status")->orderByRaw("-sort_date DESC")->get();
    ...
    {
        return view('components.DeadLine.changestatus');
    }
