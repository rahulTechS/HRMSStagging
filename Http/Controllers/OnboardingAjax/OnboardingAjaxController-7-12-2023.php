 ...
 */			$whereraw1 = '';
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderBy("caption","DESC")->whereIn("visa_process_status",array(1,2))->where("backout_status",1)->whereRaw($whereraw)->paginate($paginationValue);
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::orderBy("caption","DESC")->whereIn("visa_process_status",array(1,2))->where("backout_status",1)->paginate($paginationValue);
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->whereIn("visa_process_status",array(1,2))->where("backout_status",1)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::whereIn("visa_process_status",array(1,2))->where("backout_status",1)->get()->count();
				}
