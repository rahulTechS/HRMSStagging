...
class OnboardingAjaxController extends Controller
{
       ...
       public function documentcollection(Request $req)
	   {
		...
		return view("OnboardingAjax/documentcollectionajax",compact('EmpName','visastagearray','r_id','visastagestatuslist','jobOpning','jobRecruiterDetails','departmentLists','productDetails','designationDetails','filterList','salaryBreakUpdetails','departmentIdArray'));
	   }
