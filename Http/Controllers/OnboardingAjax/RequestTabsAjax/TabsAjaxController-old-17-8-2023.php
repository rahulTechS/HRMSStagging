...
class TabsAjaxController extends Controller
{
	   ...
	   public function summaryTabWithFullViewAjax(Request $request)
	   {
			...
			*/
		    ...
		    if($documentCollectionDetails->bgverification_status == 1 && $documentCollectionDetails->onboard_status == 1 || $documentCollectionDetails->approval_for_skip_status==1)
			{
		...
		/* 	echo '<pre>';
			...
			{
				if($documentCollectionDetails->bgverification_status == 1  || $documentCollectionDetails->approval_for_skip_status==1)
				{
