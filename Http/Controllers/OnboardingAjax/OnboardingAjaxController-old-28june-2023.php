...
class OnboardingAjaxController extends Controller
{
	 ...
	 function getDesignationOfDocumentation(Request $request)
	  ...
	  public function getSalaryBreakupDocumentAjax(Request $request)
	   ...
	   public function uploadonboardDocumentAjax(Request $request)
	   {
		   ...
		   return view("OnboardingAjax/uploadonboardDocumentAjax",compact('documentDetails','documentAttributes','uploadDetails'));
	   }
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("visa_approved_date DESC")->whereRaw($whereraw)->where("ok_visa",2)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->whereRaw($whereraw)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
				}
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::where("ok_visa",2)->orderByRaw("visa_approved_date DESC")->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->orderBy('id','DESC')->get();
				}
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->where("ok_visa",2)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::where("ok_visa",2)->get()->count();
				}
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("visa_requested_date DESC")->whereRaw($whereraw)->where("ok_visa",3)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->whereRaw($whereraw)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
				}
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::where("ok_visa",3)->orderByRaw("visa_requested_date DESC")->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->orderBy('id','DESC')->get();
				}
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->where("ok_visa",3)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::where("ok_visa",3)->get()->count();
				}
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("onboard_date DESC")->where("onboard_status",2)->whereRaw($whereraw)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->whereRaw($whereraw)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
				}
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("onboard_date DESC")->where("onboard_status",2)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->orderBy('id','DESC')->get();
				}
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->where("onboard_status",2)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::where("onboard_status",2)->get()->count();
				}
...
public function departmentListDataofferlettercomplete(Request $request)
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("offer_letter_document_date DESC")->whereRaw($whereraw)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->where("onboard_status",1)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->whereRaw($whereraw)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
				}
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("offer_letter_document_date DESC")->where("offer_letter_onboarding_status",2)->where("backout_status",1)->where("onboard_status",1)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->orderBy('id','DESC')->get();
				}
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->where("offer_letter_onboarding_status",2)->where("backout_status",1)->where("onboard_status",1)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::where("offer_letter_onboarding_status",2)->where("backout_status",1)->where("onboard_status",1)->get()->count();
				}
 ...
 */			$whereraw1 = '';
		...
		$filterList['visa_process_status'] = '';
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("visa_inprogress_date DESC")->whereRaw($whereraw)->where("visa_process_status",2)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->whereRaw($whereraw)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
				}
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::where("visa_process_status",2)->orderByRaw("visa_inprogress_date DESC")->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->orderBy('id','DESC')->get();
				}
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->where("visa_process_status",2)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::where("visa_process_status",2)->get()->count();
				}
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::orderByRaw("visa_complete_date DESC")->whereRaw($whereraw)->where("visa_process_status",4)->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->whereRaw($whereraw)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->whereRaw($whereraw)->orderBy('id','DESC')->get();
				}
				...
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::where("visa_process_status",4)->orderByRaw("visa_complete_date DESC")->paginate($paginationValue);
					//$departmentLists =  Department::where("status",1)->orderBy("id","DESC")->get();
					//$productDetails =  Product::where("status",1)->orderBy('id','DESC')->get();
					//$designationDetails =  Designation::where("status",1)->orderBy('id','DESC')->get();
				}
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->where("visa_process_status",4)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::where("visa_process_status",4)->get()->count();
				}
