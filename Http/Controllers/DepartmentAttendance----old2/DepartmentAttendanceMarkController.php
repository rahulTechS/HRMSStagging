...
class DepartmentAttendanceMarkController extends Controller
{
	...
	public  function Index(Request $request)
	{
		...
		return view("DepartmentAttendance/index",compact('empData','departmentLists','designation','tL_details','firstVisit'));
	}


	public function leaveAttendancePage(Request $request)
	{
		Session::forget('first_visit'); // Removes a specific variable
		Auth::logout();
		Session::flush();
