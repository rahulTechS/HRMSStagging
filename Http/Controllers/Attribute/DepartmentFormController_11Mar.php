...
class DepartmentFormController extends Controller
{
	...
	public function loadBankContentsMashreqCard(Request $request)
	{
        ...
        return view("Attribute/Mashreq/loadBankContentsMashreqCard",compact('id','departmentFormDetails','DepartmentNameDetails','departmentFormParentDetails','departmentFormParentTotal','Employee_details','searchValues','form_status','user_id','username','tableID','search_internal_flag','CurrentMonthFilter'));
