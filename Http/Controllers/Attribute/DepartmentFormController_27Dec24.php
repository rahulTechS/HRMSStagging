...
class DepartmentFormController extends Controller
{
	...
	public function loadBankContentsMashreqCard(Request $request)
	{
        ...
        return view("Attribute/Mashreq/loadBankContentsMashreqCard",compact('id','departmentFormDetails','DepartmentNameDetails','departmentFormParentDetails','departmentFormParentTotal','Employee_details','searchValues','form_status','user_id','username','tableID','search_internal_flag'));
	}
	...
	public function loadBankContentsMashreqCardFinalMTD(Request $request)
	{
		...
		$datasMashreqMTD = DB::table('mashreq_final_mtd_mis')->whereRaw($whereRaw)->orderby('dateofdisbursal','DESC')->paginate($paginationValue);
		$datasMashreqMTDCount = DB::table('mashreq_final_mtd_mis')->whereRaw($whereRaw)->orderby('dateofdisbursal','DESC')->count();
	   ...
	   /*  echo "<pre>";
		...
		echo "done";
		exit;     */
		 return view("Attribute/Mashreq/loadBankContentsMashreqCardFinalMTD",compact('datasMashreqMTD','searchValues','datasMashreqMTDCount','Employee_details'));
	}
