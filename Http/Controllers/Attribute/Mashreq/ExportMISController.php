...
class ExportMISController extends Controller
{
			...
			if(@$_REQUEST['all']==1)
			 {
				...
				if(@$request->session()->get('ref_no_string') != '' && @$request->session()->get('form_id') != '')
					...
					{
						$team = array();
						$team_Mahwish_130 = array('Ajay','Mujahid','Akshada');
						$team_Umar_168 = array('Arsalan','Zubair','Umer');
						$team_Arsalan_129 = array('Mohsin','Sahir','Sahir Arsalan','Shahnawaz','Anas');
 ...
 public function exportDocReportinternalMisMashreqCardsEmp(Request $request)
 {
			...
			$team_Mahwish_130 = array('Ajay','AJAY','Mujahid','Akshada');
			$team_Umar_168 = array('Arsalan','Zubair','Umer');
			$team_Arsalan_129 = array('Mohsin','Sahir','Sahir Arsalan','Shahnawaz','Anas');
			...
			$sheet = $spreadsheet->getActiveSheet();
				...
				$spreadsheet->getActiveSheet()->setTitle('Peformance Summary');
				
				$this->sheet1Performance($spreadsheet,$title,$whereRawMain,$whereRawLogin,$whereRawBooking,$start_date_internal,$end_date_internal);
	...
	protected function sheet2Performance($spreadsheet,$title,$whereRawMain,$whereRawLogin,$whereRawBooking,$start_date_internal,$end_date_internal)
	{
			...
			$sheet->setCellValue('D'.$indexCounter, strtoupper('Target'))->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$sheet->setCellValue('F'.$indexCounter, strtoupper($currentMonth.' Submission'))->getStyle('F'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('G'.$indexCounter, strtoupper($currentMonth.' Booking'))->getStyle('G'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('H'.$indexCounter, strtoupper($lastMonth. ' Submission'))->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('I'.$indexCounter, strtoupper($lastMonth. ' Booking'))->getStyle('I'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('J'.$indexCounter, strtoupper($lastToLastMonth. ' Submission'))->getStyle('J'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('K'.$indexCounter, strtoupper($lastToLastMonth. ' Booking'))->getStyle('K'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');


			$sheet->setCellValue('L'.$indexCounter, strtoupper('DOJ'))->getStyle('L'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$sheet->setCellValue('O'.$indexCounter, strtoupper('LWD'))->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('P'.$indexCounter, strtoupper('Attrition Status'))->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('Q'.$indexCounter, strtoupper('Approval Rate'))->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('R'.$indexCounter, strtoupper('W1 Flag'))->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('S'.$indexCounter, strtoupper('W1 Date'))->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('T'.$indexCounter, strtoupper('W2 Flag'))->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('U'.$indexCounter, strtoupper('W2 Date'))->getStyle('U'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('V'.$indexCounter, strtoupper('W3 Flag'))->getStyle('V'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('W'.$indexCounter, strtoupper('W3 Date'))->getStyle('W'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('X'.$indexCounter, strtoupper('Salary Change Flag'))->getStyle('X'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('Y'.$indexCounter, strtoupper('Old Sal '))->getStyle('Y'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('Z'.$indexCounter, strtoupper('New Sal'))->getStyle('Z'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('AA'.$indexCounter, strtoupper('Change Date'))->getStyle('AA'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			foreach ($selectedId as $mis) {
			  ...
			  $target = @$Employee_details_data->target;
				...
				if($LWD!='')
				{
					$diffLWD = strtotime(date('Y-m-d')) - strtotime($LWD);
					if($diffLWD>0)
					{
						$attrition_status = 'Inactive';
					}
				}
			...
			if($empAttr != '')
				...
				$sheet->setCellValue('D'.$indexCounter, $target)->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('E'.$indexCounter, $this->getDesignation($mis->emp_id))->getStyle('E'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				...
				$sheet->setCellValue('H'.$indexCounter,$lastMonthSubmission)->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('I'.$indexCounter,$lastMonthBooking)->getStyle('I'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

				$sheet->setCellValue('J'.$indexCounter,$lastToLastMonthSubmission)->getStyle('J'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('K'.$indexCounter, $lastToLastMonthBooking)->getStyle('K'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				

					

				$sheet->setCellValue('L'.$indexCounter, ($doj?date("d-m-Y",strtotime($doj)):'NA'))->getStyle('L'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

				$sheet->setCellValue('M'.$indexCounter, $this->getRangeID($vintageDays))->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

				$sheet->setCellValue('N'.$indexCounter, $vintageDays)->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

				

				$sheet->setCellValue('O'.$indexCounter, $LWD)->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

				$sheet->setCellValue('P'.$indexCounter, $attrition_status)->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					...
					$warn3Flag='';
					$warn3Date='';
					$warningDetailsData = WarningLetterRequest::select("counter","approved_status","warning_letter_issued_on")->where("emp_id",$mis->emp_id)->where('warning_letter_status',1)->where('final_status',1)->where('counter',1)->orderBy("id","DESC")->first();

					if($warningDetailsData != '')
					{
						if($warningDetailsData->counter==1)
						{
							$warnFlag="Yes";
							$warnDate= date("d-m-Y",strtotime($warningDetailsData->warning_letter_issued_on));

							$warningDetailsData2 = WarningLetterRequest::select("counter","approved_status","warning_letter_issued_on")->where("emp_id",$mis->emp_id)->where('warning_letter_status',1)->where('final_status',1)->where('counter',2)->orderBy("id","DESC")->first();

							if($warningDetailsData2 != '')
							{
								if($warningDetailsData2->counter==2)
								{
									$warn2Flag="Yes";
									$warn2Date= date("d-m-Y",strtotime($warningDetailsData2->warning_letter_issued_on));

									$warningDetailsData3 = WarningLetterRequest::select("counter","approved_status","warning_letter_issued_on")->where("emp_id",$mis->emp_id)->where('warning_letter_status',1)->where('final_status',1)->where('counter',3)->orderBy("id","DESC")->first();

									if($warningDetailsData3 != '')
									{
										if($warningDetailsData3->counter==3)
										{
											$warn3Flag="Yes";
											$warn3Date= date("d-m-Y",strtotime($warningDetailsData3->warning_letter_issued_on));
										}
									}
									else
									{
					...
					$salaryDetailsData = ChangeSalary::select("approvedrejectstatus","approvedrejecton","oldsalary","newsalary")->where("emp_id",$mis->emp_id)->where('approvedrejectstatus',1)->orderBy("id","DESC")->first();
					if($salaryDetailsData != '')
					{
						$salaryFlag="Yes";
						$salaryDate=date("d-m-Y",strtotime($salaryDetailsData->approvedrejecton));;
						$salaryOld=$salaryDetailsData->oldsalary;
						$salaryNew=$salaryDetailsData->newsalary;
					...
					$approval_rate = 0;
					if($SubmissionCount>0 && $BookingCount>0)
					{
						$approval_rate = round(($BookingCount/$SubmissionCount)*100,0);
					}
					
					$sheet->setCellValue('Q'.$indexCounter, $approval_rate)->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

					$sheet->setCellValue('R'.$indexCounter, $warnFlag)->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('S'.$indexCounter, $warnDate)->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('T'.$indexCounter, $warn2Flag)->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('U'.$indexCounter, $warn2Date)->getStyle('U'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('V'.$indexCounter, $warn3Flag)->getStyle('V'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('W'.$indexCounter, $warn3Date)->getStyle('W'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('X'.$indexCounter, $salaryFlag)->getStyle('X'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('Y'.$indexCounter, $salaryOld)->getStyle('Y'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('Z'.$indexCounter, $salaryNew)->getStyle('Z'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('AA'.$indexCounter, $salaryDate)->getStyle('AA'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			*/
			...
			///////////// Total ////////
				...
				$MSCountTotal = DB::table('mashreq_booking_mis')->whereRaw($whereRawBooking." AND emp_id IS NULL AND (card_status='Approved' OR card_status='Approved from Digital')")->get(['id'])->count();
				...
				$NCLoginCountTotal = DB::table('mashreq_booking_mis')->whereRaw($whereRawBooking." AND (ref_no IS NULL OR ref_no='') AND (card_status='Approved' OR card_status='Approved from Digital')")->get(['id'])->count();
	...
	protected function sheet1Performance($spreadsheet,$title,$whereRawMain,$whereRawLogin,$whereRawBooking,$start_date_internal,$end_date_internal)
	{
			$currentMonth =  date('M');
			$lastMonth =  date('M', strtotime('-1 month'));
			$lastToLastMonth =  date('M', strtotime('-2 month'));
			...
			$sheet->setCellValue('C'.$indexCounter, strtoupper($lastToLastMonth.' Bookings'))->getStyle('C'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('D'.$indexCounter, strtoupper($lastMonth.' Bookings'))->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('E'.$indexCounter, strtoupper($currentMonth. ' Bookings'))->getStyle('E'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			
			

			$whereRawGroup = " form_id='1' AND team!='#N/A' AND team!='0' AND team IS NOT NULL GROUP BY team";
			...
			$selectedId = DB::table('department_form_parent_entry')->whereRaw($whereRawGroup)->orderby('team','ASC')->get(['team']);
			$sn = 1;
			...
			foreach ($selectedId as $mis) {
				...
				$sheet->setCellValue('C'.$indexCounter, $this->lastToLastMonthBookingTeam($mis->team,serialize(array()),date('Y-m-d')))->getStyle('C'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

				$sheet->setCellValue('D'.$indexCounter, $this->lastMonthBookingTeam($mis->team,serialize(array()),date('Y-m-d')))->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');			


				$sheet->setCellValue('E'.$indexCounter, $BookingCountTeam)->getStyle('E'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');	
			...
			$sheet->setCellValue('G1', 'Total Headcount By Team')->getStyle('G1')->getAlignment()->setHorizontal('center')->setVertical('top');
			$indexCounter = 2;			
			
			$sheet->setCellValue('G'.$indexCounter, strtoupper('TL'))->getStyle('G'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			
			$sheet->setCellValue('H'.$indexCounter, strtoupper($lastToLastMonth.' Count'))->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('I'.$indexCounter, strtoupper($lastMonth.' Count'))->getStyle('I'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('J'.$indexCounter, strtoupper($currentMonth. ' Count'))->getStyle('J'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				
				$selectTL = DB::table('tl_list')->whereRaw("bank='Mashreq'")->get(['tl_name','emp_id','user_id']);
				
				foreach ($selectTL as $selectTLData) 
				{				
					$indexCounter++; 	
					
					$tl_id = $selectTLData->user_id;
					$tl_name = $selectTLData->tl_name;

					$CM_HeadCount = DB::table('employee_details')->whereRaw("dept_id = '36' AND tl_id='".$tl_id."' AND job_function='2' AND offline_status='1'")->get(['id'])->count();

					$LM_HeadCount = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND TL='".$tl_name."' AND sort_order=((select MAX(sort_order) as mso from master_payout_pre limit 0,1)-1)")->get(['id'])->count();

					$L3M_HeadCount = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND TL='".$tl_name."' AND sort_order=((select MAX(sort_order) as mso from master_payout_pre limit 0,1)-2)")->get(['id'])->count();
					
					$sheet->setCellValue('G'.$indexCounter, $tl_name)->getStyle('G'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');				
					

					$sheet->setCellValue('H'.$indexCounter, $L3M_HeadCount)->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

					$sheet->setCellValue('I'.$indexCounter, $LM_HeadCount)->getStyle('I'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

					$sheet->setCellValue('J'.$indexCounter, $CM_HeadCount)->getStyle('J'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');			
				}
			...
			$spreadsheet->getActiveSheet()->getStyle('G1:J1')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('cbddf7');
	...
	protected function sheet4FlagDetails($spreadsheet,$title,$whereRawMain,$whereRawLogin,$whereRawBooking,$start_date_internal,$end_date_internal)
	{
			...
			if($check_data>0)
			{
				...
				$sheet->setCellValue('K'.$indexCounter, strtoupper('TL'))->getStyle('K'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('L'.$indexCounter, strtoupper('Attrition Flag'))->getStyle('L'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('M'.$indexCounter, strtoupper('W1 Flag'))->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('N'.$indexCounter, strtoupper('W1 Date'))->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('O'.$indexCounter, strtoupper('W2 Flag'))->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('P'.$indexCounter, strtoupper('W2 Date'))->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('Q'.$indexCounter, strtoupper('W3 Flag'))->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('R'.$indexCounter, strtoupper('W3 Date'))->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('S'.$indexCounter, strtoupper('Salary Change Flag'))->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('T'.$indexCounter, strtoupper('Old Sal '))->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('U'.$indexCounter, strtoupper('New Sal'))->getStyle('U'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('V'.$indexCounter, strtoupper('Change Date'))->getStyle('V'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				...
				foreach ($selectedEmp as $selectedEmpData) 
				{
					...
					$empDetailsData = Employee_details::select("offline_status")->where("emp_id",$selectedEmpData->employee_id)->first();
					if($empDetailsData != '')
					{
						if($empDetailsData->offline_status==1)
						{
							$attritionFlag="No";
						}
						else
					...
					$warn3Flag='';
					$warn3Date='';
					$warningDetailsData = WarningLetterRequest::select("counter","approved_status","warning_letter_issued_on")->where("emp_id",$selectedEmpData->employee_id)->where('warning_letter_status',1)->where('final_status',1)->where('counter',1)->orderBy("id","DESC")->first();
					...
					if($warningDetailsData != '')
					{
						if($warningDetailsData->counter==1)
						{
							...
							$warningDetailsData2 = WarningLetterRequest::select("counter","approved_status","warning_letter_issued_on")->where("emp_id",$selectedEmpData->employee_id)->where('warning_letter_status',1)->where('final_status',1)->where('counter',2)->orderBy("id","DESC")->first();
							...
							if($warningDetailsData2 != '')
							{
								if($warningDetailsData2->counter==2)
								{
									...
									$warningDetailsData3 = WarningLetterRequest::select("counter","approved_status","warning_letter_issued_on")->where("emp_id",$selectedEmpData->employee_id)->where('warning_letter_status',1)->where('final_status',1)->where('counter',3)->orderBy("id","DESC")->first();
					...
					$salaryDetailsData = ChangeSalary::select("approvedrejectstatus","approvedrejecton","oldsalary","newsalary")->where("emp_id",$selectedEmpData->employee_id)->where('approvedrejectstatus',1)->orderBy("id","DESC")->first();
					if($salaryDetailsData != '')
					{
						$salaryFlag="Yes";
						$salaryDate=date("d-m-Y",strtotime($salaryDetailsData->approvedrejecton));;
					...
					$sheet->setCellValue('K'.$indexCounter, $selectedEmpData->tl_name)->getStyle('K'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('L'.$indexCounter, $attritionFlag)->getStyle('L'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('M'.$indexCounter, $warnFlag)->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('N'.$indexCounter, $warnDate)->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('O'.$indexCounter, $warn2Flag)->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('P'.$indexCounter, $warn2Date)->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('Q'.$indexCounter, $warn3Flag)->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('R'.$indexCounter, $warn3Date)->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('S'.$indexCounter, $salaryFlag)->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('T'.$indexCounter, $salaryOld)->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('U'.$indexCounter, $salaryNew)->getStyle('U'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
					$sheet->setCellValue('V'.$indexCounter, $salaryDate)->getStyle('V'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			else
			{
				...
				/////////// for 2nd //////////
				$check_data_1 = MasterPayout::select("id")->where("dept_id",'36')->whereRaw("sort_order='".($max_sort_order-1)."'")->get()->count();	
				///////////////////// /////////////
				...
				{
						$selectedIdPre = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND agent_product='Card' AND sort_order='".($max_sort_order-1)."'")->limit(1)->orderby('sort_order','DESC')->groupBy('sales_time')->get(['sort_order','sales_time']);
						$sort_order_1 = $selectedIdPre[0]->sort_order;
						$sales_time_1 = $selectedIdPre[0]->sales_time;

						$sheet->setCellValue('D'.$indexCounter, $sales_time_1)->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
						$sheet->setCellValue('G'.$indexCounter, strtoupper('Range ID -'.$sales_time_1))->getStyle('G'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
						
						$check_data_2 = MasterPayout::select("id")->where("dept_id",'36')->whereRaw("sort_order='".($max_sort_order-2)."'")->get()->count();
						if($check_data_2>0)
						{
							$selectedId = DB::table('master_payout')->whereRaw("dept_id = '36' AND agent_product_id='1'")->limit(1)->orderby('sort_order','DESC')->groupBy('sales_time')->get(['sales_time','sort_order','range_id']);
							...
							{							
								...
								$sort_order_2 = $mis->sort_order;
								$sales_time_2 = $mis->sales_time;
						...
						{
							$selectedIdPre2 = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND agent_product='Card' AND sort_order='".($max_sort_order-2)."'")->limit(1)->orderby('sort_order','DESC')->groupBy('sales_time')->get(['sort_order','sales_time']);
							$sort_order_2 = $selectedIdPre2[0]->sort_order;
							$sales_time_2 = $selectedIdPre2[0]->sales_time;

							$sheet->setCellValue('E'.$indexCounter, $sales_time_2)->getStyle('E'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
							$sheet->setCellValue('H'.$indexCounter, strtoupper('Range ID -'.$sales_time_2))->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
						}
				...
				//$sort_orders = substr(@$sort_orders,0,-1);
				$sort_orders = $max_sort_order.','.$sort_order_1.','.$sort_order_2;
			
				
				//$selectedEmp = DB::table('master_payout')->whereRaw("dept_id = '36' AND agent_product_id='1' AND (employee_id!='' OR employee_id IS NOT NULL) AND employee_id NOT LIKE '%,%' AND employee_id NOT LIKE '%.%' AND sort_order IN (".$sort_orders.")")->groupBy('employee_id')->get(['employee_id','agent_name','range_id','doj','tl_name']);

				$selectedEmp = DB::table('master_payout')->whereRaw("dept_id = '36' AND agent_product_id='1' AND (employee_id!='' OR employee_id IS NOT NULL) AND employee_id NOT LIKE '%,%' AND employee_id NOT LIKE '%.%' AND sort_order >=".($sort_order_2 - 1))->groupBy('employee_id')->get(['employee_id','agent_name','range_id','doj','tl_name']);
				$sn = 1;
				...
				foreach ($selectedEmp as $selectedEmpData) 
				{
					...
					$FirstData = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND sort_order ='".$max_sort_order."' AND agent_id='".$selectedEmpData->employee_id."' AND agent_product='Card'")->get(['tc','flag_rule_name','range_id','agent_target']);	
					...
					$SecondData = DB::table('master_payout')->whereRaw("dept_id = '36' AND agent_product_id='1' AND sort_order ='".($max_sort_order-1)."' AND employee_id='".$selectedEmpData->employee_id."'")->get(['cards_mashreq','flag_rule_name','agent_target','range_id']);				
					...
					{
						$SecondData = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND sort_order ='".($max_sort_order-1)."' AND agent_id='".$selectedEmpData->employee_id."' AND agent_product='Card'")->get(['tc','flag_rule_name','range_id','agent_target']);	
					...
					$ThirdData = DB::table('master_payout')->whereRaw("dept_id = '36' AND agent_product_id='1' AND sort_order ='".($max_sort_order-2)."' AND employee_id='".$selectedEmpData->employee_id."'")->get(['cards_mashreq','flag_rule_name','range_id']);				
					...
					{
						$ThirdData = DB::table('master_payout_pre')->whereRaw("dept_id = '36' AND sort_order ='".($max_sort_order-2)."' AND agent_id='".$selectedEmpData->employee_id."' AND agent_product='Card'")->get(['tc','flag_rule_name','range_id','agent_target']);	
 ...
 public function exportENBDLoanInternalMIS(Request $request)
 {
			...
			$indexCounter = 1;
			$sheet->setCellValue('A'.$indexCounter, strtoupper('DATE OF SUBMISSION'))->getStyle('A'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$sheet->setCellValue('C'.$indexCounter, strtoupper('Location'))->getStyle('C'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('D'.$indexCounter, strtoupper('EMP ID'))->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$sheet->setCellValue('F'.$indexCounter, strtoupper('CM NAME'))->getStyle('F'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('G'.$indexCounter, strtoupper('MOBILE'))->getStyle('G'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('H'.$indexCounter, strtoupper('GENDER'))->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			
			$sheet->setCellValue('I'.$indexCounter, strtoupper('DATE OF BIRTH'))->getStyle('I'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('J'.$indexCounter, strtoupper('MARITIAL STATUS'))->getStyle('J'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$sheet->setCellValue('L'.$indexCounter, strtoupper('SALARY'))->getStyle('L'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('M'.$indexCounter, strtoupper('COMPANY'))->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('N'.$indexCounter, strtoupper('FIRST PAYMENT DATE'))->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('O'.$indexCounter, strtoupper('A/C #'))->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('P'.$indexCounter, strtoupper('Product Type'))->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('Q'.$indexCounter, strtoupper('BANK'))->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('R'.$indexCounter, strtoupper('LOAN'))->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('S'.$indexCounter, strtoupper('ROI'))->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('T'.$indexCounter, strtoupper('TENURE'))->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('U'.$indexCounter, strtoupper('AECB Score'))->getStyle('U'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('V'.$indexCounter, strtoupper('STAGE'))->getStyle('V'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('W'.$indexCounter, strtoupper('Disbursal Date'))->getStyle('W'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('X'.$indexCounter, strtoupper('Cancellation/Rejection Date'))->getStyle('X'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');

			$sheet->setCellValue('Y'.$indexCounter, strtoupper('COMMENTS'))->getStyle('Y'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$emp_name= @$Employee_details_data->first_name.(@$Employee_details_data->middle_name ? " ".@$Employee_details_data->middle_name:'').(@$Employee_details_data->last_name?" ".@$Employee_details_data->last_name:'');
				 ...
				 $indexCounter++; 	
				$location = (($mis->aecb_id=='Abu Dhabi')?$mis->aecb_id:'Dubai');
				$sheet->setCellValue('A'.$indexCounter, date("d-m-Y",strtotime($mis->date_of_submission)))->getStyle('A'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('B'.$indexCounter, $mis->app_id)->getStyle('B'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('C'.$indexCounter,$location)->getStyle('C'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('D'.$indexCounter,$mis->emp_id)->getStyle('D'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('E'.$indexCounter,$mis->team)->getStyle('E'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('F'.$indexCounter, $mis->cm_full_name)->getStyle('F'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');	
				$sheet->setCellValue('G'.$indexCounter, $mis->mobile)->getStyle('G'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('H'.$indexCounter, $mis->gender)->getStyle('H'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');		
				$sheet->setCellValue('I'.$indexCounter, date("d-m-Y",strtotime($mis->date_of_birth)))->getStyle('I'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('J'.$indexCounter, $mis->marital_status)->getStyle('J'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				...
				$sheet->setCellValue('L'.$indexCounter, $mis->salary)->getStyle('L'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('M'.$indexCounter, $mis->company_name)->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('N'.$indexCounter, date("d-m-Y",strtotime($mis->first_payment_date)))->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('O'.$indexCounter, $mis->account_no)->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('P'.$indexCounter, $mis->scheme_name)->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('Q'.$indexCounter, $mis->bank)->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('R'.$indexCounter, $mis->loan_amount)->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('S'.$indexCounter, $mis->roi)->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('T'.$indexCounter, $mis->tenure)->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('U'.$indexCounter, $mis->aecb_score)->getStyle('U'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('V'.$indexCounter, $mis->application_status)->getStyle('V'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('W'.$indexCounter, date("d-m-Y",strtotime($mis->disbursal_date)))->getStyle('W'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('X'.$indexCounter, date("d-m-Y",strtotime($mis->approval_date)))->getStyle('X'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('Y'.$indexCounter, $mis->comment)->getStyle('Y'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
 ...
 public function cdaDeviationUpdate(Request $request)
	...
	protected function lastMonthSubmissionByTeam($team,$start_date_internal)
	{
		...
		$lastMonthSubmission = DB::table('department_form_parent_entry')->whereRaw("form_id='1' AND submission_date>='".$startDate."' AND submission_date<='".$endDate."' AND team='".$team."'")->get(['id'])->count();
	...
	protected function lastToLastMonthBookingTeam($team,$empId,$start_date_internal)
	{
		$empId = unserialize($empId);
