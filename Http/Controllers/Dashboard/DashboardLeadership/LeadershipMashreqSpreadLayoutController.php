...
class LeadershipMashreqSpreadLayoutController extends Controller
{
	
	public function searchLeadershipMashreqSpreadWid(Request $request)
	{
	...
	public function resetsearchLeadershipMashreqSpread(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeLeadershipMashreqSpread(Request $request)
	{
		$wid = $request->wid;
		//echo $_GET['month'];
		if($request->month=='cm'){
		$request->session()->put('widgetFilterHiring['.$wid.'][data_type]','current_month');		
		}
		elseif($request->month=='lm'){
			$request->session()->put('widgetFilterHiring['.$wid.'][data_type]','last_month');	
		}
		elseif($request->month=='l3m'){
			$request->session()->put('widgetFilterHiring['.$wid.'][data_type]','month_3');	
		}

		 
		//echo $wid;exit;
		return view("components/DashboardLeadership/reloadmeLeadershipmashreqspread",compact('wid'));
	}
	
	
	public function expandLeadershipMashreqSpread(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeLeadershipMashreqSpread/'.$wid);
	}
	
	public function compressLeadershipMashreqSpread(Request $request)
	{
		$wid = $request->wid;
	...
	public function datesearchLeadershipMashreqSpread(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		...
		return redirect('reloadmeLeadershipMashreqSpread/'.$widgetID);
	}
	
	
	
	public function LeadershipMashreqspreadByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LeadershipMashreqByTable(Request $request)
	{
		$widgetID = $request->wid;
	...
	public function LeadershipMashreqspreadLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLeadershipMashreqspreadCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLeadershipMashreqspreadLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLeadershipMashreqspread3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
...
//print_r($totaldata);exit;
		...
		if($whererawrange != '')
			...
			$empdata  = Employee_details::where('sales_name',$team)->where('dept_id',36)->where('job_function',3)->first();
					...
					$totalemp  = Employee_details::where('tl_id',$empdata->id)->whereNotIn('emp_id',$finalarrayempid)->where('offline_status',1)->whereRaw($whererawrange)->where('dept_id',36)->get();
			...
			$empdata  = Employee_details::where('sales_name',$team)->where('dept_id',36)->where('job_function',3)->first();
					...
					$totalemp  = Employee_details::where('tl_id',$empdata->id)->where('offline_status',1)->whereNotIn('emp_id',$finalarrayempid)->where('dept_id',36)->get();
		...
		return view("components/DashboardLeadership/empCountDetailspopup",compact('totalemp','range','salestime'));
...
//print_r($totaldata);exit;
		...
		if($whererawrange != '')
			...
			$empdata  = Employee_details::where('sales_name',$team)->where('dept_id',36)->where('job_function',3)->first();
					...
					$totalemp  = Employee_details::where('tl_id',$empdata->id)->whereIn('emp_id',$finalarrayempid)->where('offline_status',1)->whereRaw($whererawrange)->where('dept_id',36)->get();
			...
			$empdata  = Employee_details::where('sales_name',$team)->where('dept_id',36)->where('job_function',3)->first();
					...
					$totalemp  = Employee_details::where('tl_id',$empdata->id)->whereIn('emp_id',$finalarrayempid)->where('offline_status',1)->where('dept_id',36)->get();
...
$totalemp  = Employee_details::whereIn('tl_id',$ids)->whereNotIn('emp_id',$finalarrayempid)->where('offline_status',1)->where('dept_id',36)->get();
...
//$totalreturndata=$count;
		...
		if($whererawrange != '')
	      ...
	      $totalemp  = Employee_details::whereIn('tl_id',$ids)->whereIn('emp_id',$finalarrayempid)->where('offline_status',1)->whereRaw($whererawrange)->where('dept_id',36)->get();
    ...
    $totalemp  = Employee_details::whereIn('tl_id',$ids)->whereIn('emp_id',$finalarrayempid)->where('offline_status',1)->where('dept_id',36)->get();
