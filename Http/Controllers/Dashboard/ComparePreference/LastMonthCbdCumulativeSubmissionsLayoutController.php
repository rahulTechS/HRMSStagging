...
class LastMonthCbdCumulativeSubmissionsLayoutController extends Controller
{
	
	public function searchCbdSubmissionsLastMonth(Request $request)
	{
	...
	public function resetsearchCbdSubmissionsLastMonth(Request $request)
	{
		...
		return redirect('reloadmeCbdSubmissionsLastMonth/'.$widgetID);
	}
	
	
	public function reloadmeCbdSubmissionsLastMonth(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/ComparePreference/reloadcbdcumulativesubmissionslastmonth",compact('wid'));
	}
	
	
	public function expandCbdSubmissionsLastMonth(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeCbdSubmissionsLastMonth/'.$wid);
	}
	
	public function compressCbdSubmissionsLastMonth(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeCbdSubmissionsLastMonth/'.$wid);
	}
	public function PerformanceCbdCumulativeSubmissionsByDateLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCbdCumulativeSubmissionsByTeamLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCbdCumulativeSubmissionsByProcessorLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceCbdCumulativeBookingLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function datesearchCbdSubmissionsLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCbdIncomeBookings(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCbdIncomeSubmissions(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LastMonthCbdCumulativeSubmissionsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LastMonthCbdCumulativeSubmissionsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function LastMonthCbdCumulativeSubmissionsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
