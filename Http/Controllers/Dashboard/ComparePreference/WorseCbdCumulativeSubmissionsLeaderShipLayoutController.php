...
class WorseCbdCumulativeSubmissionsLeaderShipLayoutController extends Controller
{
	
	public function searchCbdSubmissionsWorseLeaderShip(Request $request)
	{
		...
		return redirect('reloadmeCbdSubmissionsWorseLeaderShip/'.$widgetID); 
	}
	
	public function resetsearchCbdSubmissionsWorseLeaderShip(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeCbdSubmissionsWorseLeaderShip(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/ComparePreference/reloadcbdcumulativesubmissionsworseleadership",compact('wid'));
	}
	
	
	public function expandCbdSubmissionsWorseLeaderShip(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeCbdSubmissionsWorseLeaderShip/'.$wid);
	}
	
	public function compressCbdSubmissionsWorseLeaderShip(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeCbdSubmissionsWorseLeaderShip/'.$wid);
	}
	public function PerformanceCbdCumulativeSubmissionsByDateWorseLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCbdCumulativeSubmissionsByTeamWorseLeaderShipLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCbdCumulativeSubmissionsByProcessorWorseLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceCbdCumulativeBookingWorseLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function datesearchCbdSubmissionsWorseLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function WorseCbdCumulativeSubmissionsLayoutByCMLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function WorseCbdCumulativeSubmissionsLayoutByLMLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function WorseCbdCumulativeSubmissionsLayoutBy3MLeaderShip(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function getTLdataforcbdworsecase(Request $request){
		$team = $request->team;
		$whereraw1 = '';
		$widgetID = $request->wid;
		$widgetId=$request->wid;
		...
		return view("components/ComparePreference/tablecbdworsecase",compact('team','widgetgraphData','widgetId'));
