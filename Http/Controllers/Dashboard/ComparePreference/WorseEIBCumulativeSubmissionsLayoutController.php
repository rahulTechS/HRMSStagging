...
class WorseEIBCumulativeSubmissionsLayoutController extends Controller
{
	
	public function searchEIBSubmissionsWorse(Request $request)
	{
		...
		return redirect('reloadmeEIBSubmissionsWorse/'.$widgetID); 
	}
	...
	public function resetsearchEIBSubmissionsWorse(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFiltermolTeam['.$widgetID.']','');	
	...
	public function reloadmeEIBSubmissionsWorse(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/ComparePreference/reloadeibcumulativesubmissionsworse",compact('wid'));
	}
	
	
	public function expandEIBSubmissionsWorse(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeEIBSubmissionsWorse/'.$wid);
	}
	
	public function compressEIBSubmissionsWorse(Request $request)
	{
		$wid = $request->wid;
	...
	public function PerformanceEIBCumulativeBookingWorse(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function datesearchEIBSubmissionsWorse(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBIncomeBookingsWorse(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBIncomeSubmissionsWorse(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function WorseEIBCumulativeSubmissionsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function WorseEIBCumulativeSubmissionsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function WorseEIBCumulativeSubmissionsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
