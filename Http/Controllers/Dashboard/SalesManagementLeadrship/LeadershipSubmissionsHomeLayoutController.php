...
namespace App\Http\Controllers\Dashboard\SalesManagementLeadrship;
...
class LeadrshipSubmissionsHomeLayoutController extends Controller
{
	
	public function searchLeadrshipSubmissionsHome(Request $request)
	{
	...
	public function resetsearchLeadrshipSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeLeadrshipSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagementLeadrship/reloadmeleadershipsubmissionshome",compact('wid'));
	}
	
	
	public function expandLeadrshipSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeLeadrshipSubmissionsHome/'.$wid);
	}
	
	public function compressLeadrshipSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeLeadrshipSubmissionsHome/'.$wid);
	}
	public function LeadrshipSubmissionsHomeByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LeadrshipSubmissionsHomeByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LeadrshipSubmissionsHomeByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function LeadrshipSubmissionsHomeLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
