...
class PerformanceEIBPlasticDistrbutionLayoutController extends Controller
{
	
	public function searchPerformanceEIBPlasticDistrbution(Request $request)
	{
	...
	public function resetsearchPerformanceEIBPlasticDistrbution(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceEIBPlasticDistrbution(Request $request)
	{
		 $wid = $request->wid;//exit;
		
		return view("components/EIB/reloadmePerformanceeibplasticdistrbution",compact('wid'));
	}
	
	
	public function expandPerformanceEIBPlasticDistrbution(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceEIBPlasticDistrbution/'.$wid);
	}
	
	public function compressPerformanceEIBPlasticDistrbution(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceEIBPlasticDistrbution/'.$wid);
	}
	public function PerformanceEIBPlasticDistrbutionBookings(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		...
		return redirect('reloadmePerformanceEIBPlasticDistrbution/'.$widgetID);
	}
	public function PerformanceEIBPlasticDistrbutionSubmissions(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBPlasticDistrbutionLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
