...
class PerformanceEIBIncomeLayoutController extends Controller
{
	
	public function searchPerformanceEIBIncome(Request $request)
	{
	...
	public function resetsearchPerformanceEIBIncome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceEIBIncome(Request $request)
	{
		$wid = $request->wid;
		
		return view("components/EIB/reloadmePerformanceeibincome",compact('wid'));
	}
	...
	public function expandPerformanceEIBIncome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceEIBIncome/'.$wid);
	}
	
	public function compressPerformanceEIBIncome(Request $request)
	{
		$wid = $request->wid;
	...
	public function PerformanceEIBIncomeLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
