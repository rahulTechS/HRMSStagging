...
class TLPerformanceEIBSpreadLayoutController extends Controller
{
	
	public function searchTLPerformanceEIBSpreadWid(Request $request)
	{
	...
	public function resetsearchTLPerformanceEIBSpread(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeTLPerformanceEIBSpread(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/EIB/reloadmeTLPerformanceeibspread",compact('wid'));
	}
	
	
	public function expandTLPerformanceEIBSpread(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeTLPerformanceEIBSpread/'.$wid);
	}
	
	public function compressTLPerformanceEIBSpread(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeTLPerformanceEIBSpread/'.$wid);
	}
	public function PerformanceEIBspreadByGraph(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBByTable(Request $request)
	{
		$widgetID = $request->wid;
	...
	public function PerformanceEIBspreadLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
