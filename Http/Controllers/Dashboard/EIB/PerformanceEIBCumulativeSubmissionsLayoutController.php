...
namespace App\Http\Controllers\Dashboard\EIB;
...
class PerformanceEIBCumulativeSubmissionsLayoutController extends Controller
{
	
	public function searchPerformanceEIBCumulativeSubmissions(Request $request)
	{
	...
	public function resetsearchPerformanceEIBCumulativeSubmissions(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceEIBCumulativeSubmissions(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/EIB/reloadmePerformanceeibcumulativesubmissions",compact('wid'));
	}
	
	
	public function expandPerformanceEIBCumulativeSubmissions(Request $request)
	{
		$wid = $request->wid;
	...
	public function compressPerformanceEIBCumulativeSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceEIBCumulativeSubmissions/'.$wid);
	}
	public function PerformanceEIBCumulativeSubmissionsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeSubmissionsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeSubmissionsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceEIBCumulativeSubmissionsLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
