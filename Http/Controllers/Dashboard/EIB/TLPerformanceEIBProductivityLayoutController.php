...
class TLPerformanceEIBProductivityLayoutController extends Controller
{
	
	public function searchTLPerformanceEIBProductivityWid(Request $request)
	{
	...
	public function resetsearchTLPerformanceEIBProductivity(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeTLPerformanceEIBProductivity(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/EIB/reloadmeTLPerformanceeibProductivity",compact('wid'));
	}
	
	
	public function expandTLPerformanceEIBProductivity(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeTLPerformanceEIBProductivity/'.$wid);
	}
	
	public function compressTLPerformanceEIBProductivity(Request $request)
	{
		$wid = $request->wid;
