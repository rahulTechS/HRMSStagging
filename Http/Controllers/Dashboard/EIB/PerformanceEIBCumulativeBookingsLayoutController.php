...
class PerformanceEIBCumulativeBookingsLayoutController extends Controller
{
	
	public function searchPerformanceEIBCumulativeBookings(Request $request)
	{
	...
	public function resetsearchPerformanceEIBCumulativeBookings(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceEIBCumulativeBookings(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/EIB/reloadmePerformanceeibcumulativebookings",compact('wid'));
	}
	
	
	public function expandPerformanceEIBCumulativeBookings(Request $request)
	{
		$wid = $request->wid;
	...
	public function compressPerformanceEIBCumulativeBookings(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceEIBCumulativeBookings/'.$wid);
	}
	public function PerformanceEIBCumulativeBookingsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeBookingsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeBookingsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceEIBCumulativeBookingsLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
