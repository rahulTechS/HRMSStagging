...
namespace App\Http\Controllers\Dashboard\EIBTest;
...
class EibtestLayoutController extends Controller
{
	
	public function searchPerformanceEibtest(Request $request)
	{
		//echo "hello";exit;
	...
	public function resetsearchPerformanceEIBApprovalRate(Request $request)
	{
		//echo "hello";exit;
	...
	public function resetsearchPerformanceEibtest(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFiltermolTeam['.$widgetID.']','');	
	...
	public function reloadmePerformanceEIBApprovalRate(Request $request)
	{
		//echo "test";exit;
		 $wid = $request->wid;
		
		return view("components/EIB/reloadmePerformanceeibapprovalrate",compact('wid'));
	}
	
	
	public function reloadmePerformanceEibtest(Request $request)
	{
		//echo "test";exit;
		 $wid = $request->wid;
		
		return view("components/EibTest/reloadmeeibtest",compact('wid'));
	}
	
	
	
	public function expandPerformanceEIBApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceEIBApprovalRate/'.$wid);
	}
	
	public function compressPerformanceEIBApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceEIBApprovalRate/'.$wid);
	}
	public function PerformanceEIBApprovalRateLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
