...
class SalesTimeLayoutController extends Controller
{
	
	public function searchSalesTime(Request $request)
	{
	...
	public function resetsearchSalesTime(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeSalesTime(Request $request)
	{
		 $wid = $request->wid;
	...
	public function expandSalesTime(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeSalesTime/'.$wid);
	}
	
	public function compressSalesTime(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeSalesTime/'.$wid);
	}
	public function SalesTimeBySM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SalesTimeBySP(Request $request)
	{
		$widgetID = $request->wid;
