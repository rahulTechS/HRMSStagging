...
namespace App\Http\Controllers\Dashboard\EIBLeadership;
...
class LeadershipEibSpreadLayoutController extends Controller
{
	
	public function searchLeadershipEibSpreadWid(Request $request)
	{
	...
	public function resetsearchLeadershipEibSpread(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeLeadershipEibSpread(Request $request)
	{
		 $wid = $request->wid;
		//echo $wid;exit;
		return view("components/EIBLeadership/reloadmeLeadershipeibspread",compact('wid'));
	}
	
	
	public function expandLeadershipEibSpread(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeLeadershipEibSpread/'.$wid);
	}
	
	public function compressLeadershipEibSpread(Request $request)
	{
		$wid = $request->wid;
	...
	public function datesearchLeadershipEibSpread(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		...
		return redirect('reloadmeLeadershipEibSpread/'.$widgetID);
	}
	
	
	
	public function LeadershipEibSpreadByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LeadershipEibByTable(Request $request)
	{
		$widgetID = $request->wid;
	...
	public function LeadershipEibSpreadLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLeadershipEibSpreadCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLeadershipEibSpreadLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLeadershipEibSpread3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
