...
class PerformanceEIBCumulativeSubmissionsHomeLayoutController extends Controller
{
	
	public function searchPerformanceEIBCumulativeSubmissionsHome(Request $request)
	
	{
		
		//$paramtersInput=$request->input();
	...
	public function resetsearchPerformanceEIBCumulativeSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceEIBCumulativeSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadmePerformanceeibcumulativesubmissionshome",compact('wid'));
	}
	
	
	public function expandPerformanceEIBCumulativeSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceEIBCumulativeSubmissions/'.$wid);
	}
	
	public function compressPerformanceEIBCumulativeSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceEIBCumulativeSubmissions/'.$wid);
	}
	public function PerformanceEIBCumulativeSubmissionsByDateHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeSubmissionsByTeamHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeSubmissionsByProcessorHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceEIBCumulativeSubmissionsLastMonthHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
