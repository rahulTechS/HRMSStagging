...
class HomeMashreqCumulativeSubmissionsLayoutController extends Controller
{
	...
	public function reloadmePerformanceMashreqCumulativeSubmissions(Request $request)
	{
		...
		return view("components/Home/reloadHomemashreqcumulativesubmissions",compact('wid'));
	}
	...
	public function HomeMashreqCumulativeSubmissionsByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function HomeMashreqCumulativeSubmissionsByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function HomeMashreqCumulativeSubmissionsBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
