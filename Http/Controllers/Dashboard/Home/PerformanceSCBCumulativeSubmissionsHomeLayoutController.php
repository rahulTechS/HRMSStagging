...
class PerformanceSCBCumulativeSubmissionsHomeLayoutController extends Controller
{
	
	public function searchPerformanceSCBCumulativeSubmissionsHome(Request $request)
	{
	...
	public function resetsearchPerformanceSCBCumulativeSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceSCBCumulativeSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadmePerformancescbcumulativesubmissionshome",compact('wid'));
	}
	
	
	public function expandPerformanceSCBCumulativeSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceSCBCumulativeSubmissionsHome/'.$wid);
	}
	
	public function compressPerformanceSCBCumulativeSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceSCBCumulativeSubmissionsHome/'.$wid);
	}
	public function PerformanceSCBCumulativeSubmissionsByDateHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeSubmissionsByTeamHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeSubmissionsByProcessorHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthSubmissionsSCBHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
