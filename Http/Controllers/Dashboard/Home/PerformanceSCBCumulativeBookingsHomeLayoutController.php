...
class PerformanceSCBCumulativeBookingsHomeLayoutController extends Controller
{
	
	public function searchPerformanceSCBCumulativeBookingsHome(Request $request)
	{
	...
	public function resetsearchPerformanceSCBCumulativeBookingsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceSCBCumulativeBookingsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadmePerformancescbcumulativebookingshome",compact('wid'));
	}
	
	
	public function expandPerformanceSCBCumulativeBookingsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceSCBCumulativeBookingsHome/'.$wid);
	}
	
	public function compressPerformanceSCBCumulativeBookingsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceSCBCumulativeBookingsHome/'.$wid);
	}
	public function PerformanceSCBCumulativeBookingsByDateHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeBookingsByTeamHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeBookingsByProcessorHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthBookingsSCBHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
