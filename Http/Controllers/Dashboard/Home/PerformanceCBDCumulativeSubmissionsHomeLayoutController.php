...
class PerformanceCBDCumulativeSubmissionsHomeLayoutController extends Controller
{
	
	public function searchPerformanceCBDCumulativeSubmissionsHome(Request $request)
	{
	...
	public function resetsearchPerformanceCBDCumulativeSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceCBDCumulativeSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadmePerformancecbdcumulativesubmissions",compact('wid'));
	}
	
	
	public function expandPerformanceCBDCumulativeSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceCBDCumulativeSubmissionsHome/'.$wid);
	}
	
	public function compressPerformanceCBDCumulativeSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceCBDCumulativeSubmissionsHome/'.$wid);
	}
	public function PerformanceCBDCumulativeSubmissionsByDateHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeSubmissionsByTeamHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeSubmissionsByProcessorHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthSubmissionsCBDHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
