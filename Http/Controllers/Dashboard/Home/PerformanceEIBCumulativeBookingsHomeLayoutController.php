...
class PerformanceEIBCumulativeBookingsHomeLayoutController extends Controller
{
	
	public function searchPerformanceEIBCumulativeBookingsHome(Request $request)
	{
	...
	public function resetsearchPerformanceEIBCumulativeBookingsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceEIBCumulativeBookingsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadmePerformanceeibcumulativebookingshome",compact('wid'));
	}
	
	
	public function expandPerformanceEIBCumulativeBookingsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceEIBCumulativeBookings/'.$wid);
	}
	
	public function compressPerformanceEIBCumulativeBookingsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceEIBCumulativeBookings/'.$wid);
	}
	public function PerformanceEIBCumulativeBookingsByDateHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeBookingsByTeamHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceEIBCumulativeBookingsByProcessorHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceEIBCumulativeBookingsLastMonthHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
