...
class PerformanceCBDCumulativeBookingsHomeLayoutController extends Controller
{
	
	public function searchPerformanceCBDCumulativeBookingsHome(Request $request)
	{
	...
	public function resetsearchPerformanceCBDCumulativeBookingsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceCBDCumulativeBookingsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadmePerformancecbdcumulativebookings",compact('wid'));
	}
	
	
	public function expandPerformanceCBDCumulativeBookingsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceCBDCumulativeBookingsHome/'.$wid);
	}
	
	public function compressPerformanceCBDCumulativeBookingsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceCBDCumulativeBookingsHome/'.$wid);
	}
	public function PerformanceCBDCumulativeBookingsByDateHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeBookingsByTeamHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeBookingsByProcessorHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthBookingsCBDHome(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
