...
class CumulativeBookingsENBDCardsLayoutController extends Controller
{
	
	public function searchCumulativeBookingsENBDCardsFilterdata(Request $request)
	{
		...
		if(isset($parametersInput['processor']) && $parametersInput['processor'] != '' && $parametersInput['processor'] != NULL )
		{
			...
			$request->session()->put('widgetBookingsFilterAleNaleStatus['.$widgetID.']',$processor);	
		}
		else
		{
			$request->session()->put('widgetBookingsFilterAleNaleStatus['.$widgetID.']','');	
		}
		...
		return redirect('reloadENBDCardsCumulativeBookings/'.$widgetID);
	}
	
	public function resetCumulativeBookingsENBDCardsFiltersData(Request $request)
	{
		//echo "hello";exit;
		...
		$request->session()->put('widgetBookingsFilterNonAleNaleStatus['.$widgetID.']','');	
	...
	public function reloadCumulativeBookingsENBDCardsData(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Home/reloadcumulativebookingsCardsENBD",compact('wid'));
	}
	
	
	public function expandPerformanceMashreqCumulativeBookings(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadENBDCardsCumulativeBookings/'.$wid);
	}
	
	public function compressPerformanceMashreqCumulativeBookings(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadENBDCardsCumulativeBookings/'.$wid);
	}
	public function PerformanceMashreqCumulativeBookingsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceMashreqCumulativeBookingsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceMashreqCumulativeBookingsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function CumulativeBookingsENBDCardsLastMonthData(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
		//sreturn redirect('widgetLoadOnDashboard/'.$widgetID);
		return redirect('reloadENBDCardsCumulativeBookings/'.$widgetID);
	}



	public function CumulativeBookingsByAleData(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
		$request->session()->put('widgetBookingsFilterAleNaleStatus['.$widgetID.']','ALE');	
		$request->session()->put('widgetBookingsFilterNonAleNaleStatus['.$widgetID.']','');	
		$request->session()->put('widgetFilterBYTeam['.$widgetID.']','');	
		//return redirect('widgetLoadOnDashboard/'.$widgetID);
		return redirect('reloadENBDCardsCumulativeBookings/'.$widgetID);
	...
	public function CumulativeBookingsByNonAleData(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
		$request->session()->put('widgetBookingsFilterNonAleNaleStatus['.$widgetID.']','NALE');	
		$request->session()->put('widgetBookingsFilterAleNaleStatus['.$widgetID.']','');	
		$request->session()->put('widgetFilterBYTeam['.$widgetID.']','');	
		//return redirect('widgetLoadOnDashboard/'.$widgetID);
		return redirect('reloadENBDCardsCumulativeBookings/'.$widgetID);
