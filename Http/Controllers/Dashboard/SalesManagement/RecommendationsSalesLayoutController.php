...
class RecommendationsSalesLayoutController extends Controller
{
	
	public function searchRecommendationSales(Request $request)
	{
	...
	public function resetRecommendationSales(Request $request)
	{
	...
	public function reloadRecommendationSales(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadrecommendations",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadRecommendationSales/'.$wid);
	}
