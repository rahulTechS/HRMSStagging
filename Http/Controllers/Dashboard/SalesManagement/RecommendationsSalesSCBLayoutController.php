...
class RecommendationsSalesSCBLayoutController extends Controller
{
	
	public function searchRecommendationSalesSCB(Request $request)
	{
	...
	public function resetRecommendationSalesSCB(Request $request)
	{
	...
	public function reloadRecommendationSalesSCB(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadrecommendationsscb",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadRecommendationSalesSCB/'.$wid);
	}
