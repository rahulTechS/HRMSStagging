...
class RecommendationsSalesCBDLayoutController extends Controller
{
	
	public function searchRecommendationSalesCBD(Request $request)
	{
		...
		return redirect('reloadRecommendationSalesCBD/'.$widgetID);
	}
	
	public function resetRecommendationSalesCBD(Request $request)
	{
	...
	public function reloadRecommendationSalesCBD(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadrecommendationscbd",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadRecommendationSalesCBD/'.$wid);
	}
