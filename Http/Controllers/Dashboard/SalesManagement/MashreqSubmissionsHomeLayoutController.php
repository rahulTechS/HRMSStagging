...
class MashreqSubmissionsHomeLayoutController extends Controller
{
	
	public function searchMashreqSubmissionsHome(Request $request)
	{
	...
	public function resetsearchMashreqSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeMashreqSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadmemashreqsubmissionshome",compact('wid'));
	}
	
	
	public function expandMashreqSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeMashreqSubmissionsHome/'.$wid);
	}
	
	public function compressMashreqSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeMashreqSubmissionsHome/'.$wid);
	}
	public function MashreqSubmissionsHomeByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function MashreqSubmissionsHomeByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function MashreqSubmissionsHomeByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function MashreqSubmissionsHomeLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
