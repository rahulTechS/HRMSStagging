...
class SCBSubmissionsHomeLayoutController extends Controller
{
	
	public function searchSCBSubmissionsHome(Request $request)
	{
	...
	public function resetsearchSCBSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeSCBSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadmescbsubmissionshome",compact('wid'));
	}
	
	
	public function expandSCBSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeSCBSubmissionsHome/'.$wid);
	}
	
	public function compressSCBSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeSCBSubmissionsHome/'.$wid);
	}
	public function SCBSubmissionsHomeByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SCBSubmissionsHomeByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SCBSubmissionsHomeByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SCBSubmissionsHomeLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
