...
class EibSubmissionsHomeLayoutController extends Controller
{
	
	public function searchEibSubmissionsHome(Request $request)
	{
	...
	public function resetsearchEibSubmissionsHome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeEibSubmissionsHome(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadmeeibsubmissionshome",compact('wid'));
	}
	
	
	public function expandEibSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeeibsubmissionshome/'.$wid);
	}
	
	public function compressEibSubmissionsHome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmeeibsubmissionshome/'.$wid);
	}
	public function EibSubmissionsHomeByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function EibSubmissionsHomeByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function EibSubmissionsHomeByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function EibSubmissionsHomeLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
