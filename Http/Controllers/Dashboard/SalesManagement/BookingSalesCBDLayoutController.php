...
class BookingSalesCBDLayoutController extends Controller
{
	
	public function searchBookingsSalesCBD(Request $request)
	{
		...
		return redirect('reloadBookingsSalesCBD/'.$widgetID);
	}
	
	public function resetWarningLetterCBD(Request $request)
	{
	...
	public function reloadBookingsSalesCBD(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadbookingscbd",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadBookingsSalesCBD/'.$wid);
	}
