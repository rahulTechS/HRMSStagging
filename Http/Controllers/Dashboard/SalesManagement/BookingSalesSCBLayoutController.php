...
class BookingSalesSCBLayoutController extends Controller
{
	
	public function searchBookingsSalesSCB(Request $request)
	{
	...
	public function resetBookingsSalesSCB(Request $request)
	{
	...
	public function reloadBookingsSalesSCB(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadbookingsscb",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadBookingsSalesSCB/'.$wid);
	}
