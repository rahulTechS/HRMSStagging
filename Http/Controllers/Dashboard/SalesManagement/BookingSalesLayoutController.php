...
class BookingSalesLayoutController extends Controller
{
	...
	public function searchWarningLetter(Request $request)
	{
		...
		return redirect('reloadBookingsSalesmgmt/'.$widgetID);
	}
	
	public function resetBookingsSalesmgmt(Request $request)
	{
	...
	public function reloadBookingsSalesmgmt(Request $request)
	{
		//echo "hello";exit;
		 $wid = $request->wid;
		
		return view("components/SalesManagement/reloadbookings",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadBookingsSalesmgmt/'.$wid);
	}
