...
class PerformanceSCBApprovalRateLayoutController extends Controller
{
	
	public function searchPerformanceSCBApprovalRateWid(Request $request)
	{
		//echo "hello";exit;
	...
	public function resetsearchPerformanceSCBApprovalRate(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceSCBApprovalRate(Request $request)
	{
		//echo "test";exit;
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancescbapprovalrate",compact('wid'));
	}
	
	
	public function expandPerformanceSCBApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceSCBApprovalRate/'.$wid);
	}
	
	public function compressPerformanceSCBApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceSCBApprovalRate/'.$wid);
	}
	public function SearchLastMonthAppSCB(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBApprovalRateLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBApprovalRateLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceSCBApprovalRateLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
