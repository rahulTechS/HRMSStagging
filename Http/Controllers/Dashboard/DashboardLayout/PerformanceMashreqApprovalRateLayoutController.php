...
class PerformanceMashreqApprovalRateLayoutController extends Controller
{
	
	public function searchPerformanceMashreqApprovalRateWid(Request $request)
	{
		//echo "hello";exit;
	...
	public function resetsearchPerformanceMashreqApprovalRate(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceMashreqApprovalRate(Request $request)
	{
		//echo "test";exit;
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancemashreqapprovalrate",compact('wid'));
	}
	
	
	public function expandPerformanceMashreqApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceMashreqApprovalRate/'.$wid);
	}
	
	public function compressPerformanceMashreqApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceMashreqApprovalRate/'.$wid);
	}
	public function PerformanceMashreqApprovalRateLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqApprovalRateCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqApprovalRateLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchMashreqApprovalRate3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
