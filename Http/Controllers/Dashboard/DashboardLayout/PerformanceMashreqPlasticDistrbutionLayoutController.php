...
class PerformanceMashreqPlasticDistrbutionLayoutController extends Controller
{
	
	public function searchPerformanceMashreqPlasticDistrbution(Request $request)
	{
	...
	public function resetsearchPerformanceMashreqPlasticDistrbution(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceMashreqPlasticDistrbution(Request $request)
	{
		 $wid = $request->wid;//exit;
		
		return view("components/Performance/reloadmePerformancemashreqplasticdistrbution",compact('wid'));
	}
	
	
	public function expandPerformanceMashreqPlasticDistrbution(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceMashreqPlasticDistrbution/'.$wid);
	}
	
	public function compressPerformanceMashreqPlasticDistrbution(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceMashreqPlasticDistrbution/'.$wid);
	}
	public function PerformanceMashreqPlasticDistrbutionBookings(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		...
		return redirect('reloadmePerformanceMashreqPlasticDistrbution/'.$widgetID);
	}
	public function PerformanceMashreqPlasticDistrbutionSubmissions(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceMashreqPlasticDistrbutionLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqPlasticDistrbutionCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqPlasticDistrbutionLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchMashreqPlasticDistrbution3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
