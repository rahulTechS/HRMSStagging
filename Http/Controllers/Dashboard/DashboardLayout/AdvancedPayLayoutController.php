...
class AdvancedPayLayoutController extends Controller
{
	
	public function searchAdvancedPay(Request $request)
	{
		...
		return redirect('reloadAdvancedPay/'.$widgetID);
	}
	
	public function resetAdvancedPay(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadAdvancedPay(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/AdvancedPay/reloadAdvancedPay",compact('wid'));
	}
	
	
	public function expandAdvancedPay(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadAdvancedPay/'.$wid);
	}
	
	public function compressAdvancedPay(Request $request)
	{
		$wid = $request->wid;
