...
class PerformanceMashreqSTPPecentagesLayoutController extends Controller
{
	
	public function searchPerformanceMashreqSTPPecentages(Request $request)
	{
	...
	public function resetsearchPerformanceMashreqSTPPecentages(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceMashreqSTPPecentages(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancemashreqstppecentages",compact('wid'));
	}
	
	
	public function expandPerformanceMashreqSTPPecentages(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceMashreqSTPPecentages/'.$wid);
	}
	
	public function compressPerformanceMashreqSTPPecentages(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceMashreqSTPPecentages/'.$wid);
	}
	public function PerformanceMashreqSTPPecentagesLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqSTPPecentagesCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqSTPPecentagesLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchMashreqSTPPecentages3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
