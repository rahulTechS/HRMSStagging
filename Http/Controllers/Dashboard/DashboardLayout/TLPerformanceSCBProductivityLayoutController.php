...
class TLPerformanceSCBProductivityLayoutController extends Controller
{
	
	public function searchTLPerformanceSCBProductivityWid(Request $request)
	{
	...
	public function resetsearchTLPerformanceSCBProductivity(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeTLPerformanceSCBProductivity(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmeTLPerformancescbProductivity",compact('wid'));
	}
	
	
	public function expandTLPerformanceSCBProductivity(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeTLPerformanceSCBProductivity/'.$wid);
	}
	
	public function compressTLPerformanceSCBProductivity(Request $request)
	{
		$wid = $request->wid;
