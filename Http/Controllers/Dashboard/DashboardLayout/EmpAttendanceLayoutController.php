...
class EmpAttendanceLayoutController extends Controller
{
	...
	public function searchEmpAttendance(Request $request)
	{
		...
		return redirect('reloadEmpAttendance/'.$widgetID);
	}
	...
	public function reloadEmpAttendance(Request $request)
	{
		...
		return view("components/Attendance/reloadEmpAttendance",compact('wid'));
	}
	...
	public function expandAttendance(Request $request)
	{
		...
		return redirect('reloadEmpAttendance/'.$wid);
	}
