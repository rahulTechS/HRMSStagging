...
class TLPerformanceCBDProductivityLayoutController extends Controller
{
	
	public function searchTLPerformanceCBDProductivityWid(Request $request)
	{
	...
	public function resetsearchTLPerformanceCBDProductivity(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeTLPerformanceCBDProductivity(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmeTLPerformancecbdProductivity",compact('wid'));
	}
	
	
	public function expandTLPerformanceCBDProductivity(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeTLPerformanceCBDProductivity/'.$wid);
	}
	
	public function compressTLPerformanceCBDProductivity(Request $request)
	{
		$wid = $request->wid;
