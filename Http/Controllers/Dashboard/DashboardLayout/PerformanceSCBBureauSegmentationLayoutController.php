...
class PerformanceSCBBureauSegmentationLayoutController extends Controller
{
	
	public function searchPerformanceSCBBureauSegmentation(Request $request)
	{
	...
	public function resetsearchPerformanceSCBBureauSegmentation(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceSCBBureauSegmentation(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancescbbureausegmentation",compact('wid'));
	}
	
	
	public function expandPerformanceSCBBureauSegmentation(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceSCBBureauSegmentation/'.$wid);
	}
	
	public function compressPerformanceSCBBureauSegmentation(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceSCBBureauSegmentation/'.$wid);
	}
	public function PerformanceSCBBureauSegmentationBookings(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBBureauSegmentationSubmissions(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBBureauSegmentationLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
