...
class ChangeSalaryLayoutController extends Controller
{
	
	public function searchChangeSalary(Request $request)
	{
		...
		return redirect('reloadChangeSalary/'.$widgetID);
	}
	
	public function resetChangeSalary(Request $request)
	{
	...
	public function reloadChangeSalary(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/ChangeSalary/reloadEmpChangeSalary",compact('wid'));
	}
	
	
	public function expandChangeSalary(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadChangeSalary/'.$wid);
	}
	
	public function compressChangeSalary(Request $request)
	{
		$wid = $request->wid;
	...
	public function SearchChangeSalaryCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchChangeSalaryLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchChangeSalary3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
