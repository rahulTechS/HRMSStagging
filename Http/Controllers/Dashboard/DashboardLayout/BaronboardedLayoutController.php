...
class BaronboardedLayoutController extends Controller
{
	...
	public function searchOnboarded(Request $request)
	{
	...
	public function resetOnboarded(Request $request)
	{
	...
	public function reloadmeBarOnboarded(Request $request)
	{
		$wid = $request->wid;
		
		return view("components/bargraph/reloadmeBarOnboarded",compact('wid'));
	}
	
	
	public function OnboardedBarLink(Request $request)
	{
		...
		*/
		...
		if($dataType == 'current_month')
		{
		...
		else if($dataType == 'last_month')
			{
				...
				$request->session()->put('datefrom_candonboard_filter_inner_list',$fromDate);
				$request->session()->put('dateto_candonboard_filter_inner_list',$toDate);
	...
	public function SearchLastMonthOnboard(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLastMonthOnboardCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchLastMonthOnboardLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchLastMonthOnboard3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
