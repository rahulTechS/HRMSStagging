...
class StampingDeadlineLayoutController extends Controller
{
	...
	public function searchStampingDeadline(Request $request)
	{
		...
		//echo "hello";exit;
		return redirect('reloadmeStampingDeadline/'.$widgetID);
	}
	...
	public function reloadmeStampingDeadline(Request $request)
	{
		...
		return view("components/DeadLine/reloadmestampingdeadline",compact('wid'));
	}
	...
	public function expandStampingDeadline(Request $request)
	{
		...
		return redirect('reloadmeStampingDeadline/'.$wid);
	}
	...
	public function StampingDeadlineAll(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function StampingDeadlineMissed(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function StampingDeadlineNotMissed(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYAll['.$widgetID.']','');	
		...
		public function StampingDeadlinebyfilter(Request $request)
	{
		$parametersInput = $request->input();
	...
	public function StampingDeadlinesetfilter(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LoadStampingDeadlineTableData(Request $request){
		$widgetId = $request->wid;
		$id = $request->empId;
		
	$docdata=DocumentCollectionDetails::where("id",$id)->first();
	
	return view("components/DeadLine/stampingdeadlineTable",compact('widgetId','docdata'));
