...
class PerformanceCBDBureauSegmentationLayoutController extends Controller
{
	
	public function searchPerformanceCBDBureauSegmentation(Request $request)
	{
	...
	public function resetsearchPerformanceCBDBureauSegmentation(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceCBDBureauSegmentation(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancecbdbureausegmentation",compact('wid'));
	}
	
	
	public function expandPerformanceCBDBureauSegmentation(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceCBDBureauSegmentation/'.$wid);
	}
	
	public function compressPerformanceCBDBureauSegmentation(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceCBDBureauSegmentation/'.$wid);
	}
	public function PerformanceCBDBureauSegmentationBookings(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDBureauSegmentationSubmissions(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDBureauSegmentationLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDBureauSegmentationLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDBureauSegmentationLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceCBDBureauSegmentationLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
