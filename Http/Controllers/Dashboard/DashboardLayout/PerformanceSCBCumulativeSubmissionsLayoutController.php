...
class PerformanceSCBCumulativeSubmissionsLayoutController extends Controller
{
	
	public function searchPerformanceSCBCumulativeSubmissions(Request $request)
	{
	...
	public function resetsearchPerformanceSCBCumulativeSubmissions(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceSCBCumulativeSubmissions(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancescbcumulativesubmissions",compact('wid'));
	}
	
	
	public function expandPerformanceSCBCumulativeSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceSCBCumulativeSubmissions/'.$wid);
	}
	
	public function compressPerformanceSCBCumulativeSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceSCBCumulativeSubmissions/'.$wid);
	}
	public function PerformanceSCBCumulativeSubmissionsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeSubmissionsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeSubmissionsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthSubmissionsSCB(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeSubmissionsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeSubmissionsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceSCBCumulativeSubmissionsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
