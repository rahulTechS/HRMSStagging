...
class PerformanceCBDApprovalRateLayoutController extends Controller
{
	
	public function searchPerformanceCBDApprovalRateWid(Request $request)
	{
		//echo "hello";exit;
	...
	public function resetsearchPerformanceCBDApprovalRate(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceCBDApprovalRate(Request $request)
	{
		//echo "test";exit;
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancecbdapprovalrate",compact('wid'));
	}
	
	
	public function expandPerformanceCBDApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceCBDApprovalRate/'.$wid);
	}
	
	public function compressPerformanceCBDApprovalRate(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceCBDApprovalRate/'.$wid);
	}
	public function SearchLastMonthAppCBD(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDApprovalRateLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDApprovalRateLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceCBDApprovalRateLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
