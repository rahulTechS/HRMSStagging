...
class PerformanceMashreqIncomeLayoutController extends Controller
{
	
	public function searchPerformanceMashreqIncome(Request $request)
	{
	...
	public function resetsearchPerformanceMashreqIncome(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceMashreqIncome(Request $request)
	{
		$wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancemashreqincome",compact('wid'));
	}
	...
	public function expandPerformanceMashreqIncome(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceMashreqIncome/'.$wid);
	}
	
	public function compressPerformanceMashreqIncome(Request $request)
	{
		$wid = $request->wid;
	...
	public function PerformanceMashreqIncomeLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqIncomeSubmissionsCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqIncomeSubmissionsLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchMashreqIncomeSubmissions3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
