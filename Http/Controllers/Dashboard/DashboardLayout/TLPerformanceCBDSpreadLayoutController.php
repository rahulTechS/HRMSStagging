...
class TLPerformanceCBDSpreadLayoutController extends Controller
{
	
	public function searchTLPerformanceCBDSpreadWid(Request $request)
	{
	...
	public function resetsearchTLPerformanceCBDSpread(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeTLPerformanceCBDSpread(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmeTLPerformancecbdspread",compact('wid'));
	}
	
	
	public function expandTLPerformanceCBDSpread(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeTLPerformanceCBDSpread/'.$wid);
	}
	
	public function compressTLPerformanceCBDSpread(Request $request)
	{
		$wid = $request->wid;
	...
	public function TLPerformanceCBDSpreadLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function TLPerformanceCBDSpreadLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function TLPerformanceCBDSpreadLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function TLPerformanceCBDSpreadLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
