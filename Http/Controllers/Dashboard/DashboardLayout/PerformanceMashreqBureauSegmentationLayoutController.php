...
class PerformanceMashreqBureauSegmentationLayoutController extends Controller
{
	
	public function searchPerformanceMashreqBureauSegmentation(Request $request)
	{
	...
	public function resetsearchPerformanceMashreqBureauSegmentation(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceMashreqBureauSegmentation(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancemashreqbureausegmentation",compact('wid'));
	}
	
	
	public function expandPerformanceMashreqBureauSegmentation(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceMashreqBureauSegmentation/'.$wid);
	}
	
	public function compressPerformanceMashreqBureauSegmentation(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceMashreqBureauSegmentation/'.$wid);
	}
	public function PerformanceMashreqBureauSegmentationBookings(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceMashreqBureauSegmentationSubmissions(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceMashreqBureauSegmentationLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqBureauSegmentationCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqBureauSegmentationLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchMashreqBureauSegmentation3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
