...
class EmployeeWarningLayoutController extends Controller
{
	...
	public function searchWarningLetter(Request $request)
	{
		...
		return redirect('reloadWarningLetter/'.$widgetID);
	}
	...
	public function reloadWarningLetter(Request $request)
	{
		...
		return view("components/Warning/reloadWarningLetter",compact('wid'));
	}
	...
	public function expandWarning(Request $request)
	{
		...
		return redirect('reloadWarningLetter/'.$wid);
	}
	...
	public function WarningLetterByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function WarningLetterByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function WarningLetterBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
