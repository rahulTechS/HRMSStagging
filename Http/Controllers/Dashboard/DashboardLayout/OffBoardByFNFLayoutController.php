...
class OffBoardByFNFLayoutController extends Controller
{
	
	public function searchOffBoardByFNF(Request $request)
	{
	...
	public function resetsearchOffBoardByFNF(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeOffBoardByFNF(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/OffBoard/reloadmeoffboardbyfnf",compact('wid'));
	}
	
	
	public function expandOffBoardByFNF(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeOffBoardByFNF/'.$wid);
	}
	
	public function compressOffBoardByFNF(Request $request)
	{
		$wid = $request->wid;
	...
	public function candidateOffBoardByFNFLink(Request $request)
	{
		//echo "hello";exit;
		$dept = $request->dept;
		$wid = $request->wid;
	...
	public function candidateOffBoardByFNFTotelLink(Request $request)
	{
		//echo "hello";exit;
	...
	public function OffBoardByFNFAll(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function OffBoardByFNFLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function OffBoardByFNFCurrentMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYAll['.$widgetID.']','');	
	...
	public function OffBoardByFNFLast3Month(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYAll['.$widgetID.']','');	
