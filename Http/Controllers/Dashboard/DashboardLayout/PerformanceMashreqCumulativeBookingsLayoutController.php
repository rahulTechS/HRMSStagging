...
class PerformanceMashreqCumulativeBookingsLayoutController extends Controller
{
	
	public function searchPerformanceMashreqCumulativeBookings(Request $request)
	{
	...
	public function resetsearchPerformanceMashreqCumulativeBookings(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceMashreqCumulativeBookings(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancemashreqcumulativebookings",compact('wid'));
	}
	...
	public function expandPerformanceMashreqCumulativeBookings(Request $request)
	{
		...
		return redirect('reloadmePerformanceMashreqCumulativeBookings/'.$wid);
	}
	...
	public function PerformanceMashreqCumulativeBookingsLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqCumulativeBookingsCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function SearchMashreqCumulativeBookingsLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function SearchMashreqCumulativeBookings3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
