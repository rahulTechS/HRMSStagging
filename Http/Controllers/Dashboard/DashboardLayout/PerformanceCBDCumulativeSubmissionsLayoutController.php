...
class PerformanceCBDCumulativeSubmissionsLayoutController extends Controller
{
	
	public function searchPerformanceCBDCumulativeSubmissions(Request $request)
	{
	...
	public function resetsearchPerformanceCBDCumulativeSubmissions(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceCBDCumulativeSubmissions(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancecbdcumulativesubmissions",compact('wid'));
	}
	
	
	public function expandPerformanceCBDCumulativeSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceCBDCumulativeSubmissions/'.$wid);
	}
	
	public function compressPerformanceCBDCumulativeSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceCBDCumulativeSubmissions/'.$wid);
	}
	public function PerformanceCBDCumulativeSubmissionsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeSubmissionsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeSubmissionsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthSubmissionsCBD(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeSubmissionsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceCBDCumulativeSubmissionsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceCBDCumulativeSubmissionsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
