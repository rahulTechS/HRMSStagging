...
class PerformanceAutoloanInternalSubmissionsLayoutController extends Controller
{
	
	public function searchPerformanceAutoloanInternalSubmissions(Request $request)
	{
	...
	public function resetsearchPerformanceAutoloanInternalSubmissions(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceAutoloanInternalSubmissions(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformanceautoloaninternalsubmissions",compact('wid'));
	}
	
	
	public function expandPerformanceAutoloanInternalSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceAutoloanInternalSubmissions/'.$wid);
	}
	
	public function compressPerformanceAutoloanInternalSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceAutoloanInternalSubmissions/'.$wid);
	}
	public function PerformanceAutoloanInternalSubmissionsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsByAmount(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsByCount(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceAutoloanInternalSubmissionsLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsOverall(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsDisbursed(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceAutoloanInternalSubmissionsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceAutoloanInternalSubmissionsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
