...
class DateEntryLayoutController extends Controller
{
	
	public function searchDateEntry(Request $request)
	{
		...
		//echo "hello";exit;
		return redirect('reloadmeDateEntry/'.$widgetID);
	}
	
	public function resetsearchDateEntry(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeDateEntry(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/DeadLine/reloadmedateentry",compact('wid'));
	}
	
	
	public function expandDateEntry(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeDateEntry/'.$wid);
	}
	
	public function compressDateEntry(Request $request)
	{
		$wid = $request->wid;
	...
	public function DateEntryLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function candidateDateEntryLink(Request $request)
	{
		//echo "hello";exit;
		$name = $request->name;
		$wid = $request->wid;
	...
	public function DateEntryAll(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function DateEntryMissed(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function DateEntryNotMissed(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYAll['.$widgetID.']','');	
	...
	public function DateEntrybyfilter(Request $request)
	{
		$parametersInput = $request->input();
	...
	public function DateEntrysetfilter(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function LoadDateEntryTableData(Request $request){
		$widgetId = $request->wid;
		$id = $request->empId;
		
	$docdata=DocumentCollectionDetails::where("id",$id)->first();
	
	return view("components/DeadLine/dateentryTable",compact('widgetId','docdata'));
