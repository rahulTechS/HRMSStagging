...
class PerformanceSCBCumulativeBookingsLayoutController extends Controller
{
	
	public function searchPerformanceSCBCumulativeBookings(Request $request)
	{
	...
	public function resetsearchPerformanceSCBCumulativeBookings(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceSCBCumulativeBookings(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancescbcumulativebookings",compact('wid'));
	}
	
	
	public function expandPerformanceSCBCumulativeBookings(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceSCBCumulativeBookings/'.$wid);
	}
	
	public function compressPerformanceSCBCumulativeBookings(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceSCBCumulativeBookings/'.$wid);
	}
	public function PerformanceSCBCumulativeBookingsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeBookingsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeBookingsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function SearchLastMonthBookingsSCB(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeBookingsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceSCBCumulativeBookingsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceSCBCumulativeBookingsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
