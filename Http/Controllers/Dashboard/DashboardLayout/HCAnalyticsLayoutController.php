...
class HCAnalyticsLayoutController extends Controller
{
	...
	public function reloadmeBarShortlistedMashrwq(Request $request)
	{
		$wid = $request->wid;
		return view("components/Hcanalytics/reloadmehcanalyticsmashreq",compact('wid'));
	}
