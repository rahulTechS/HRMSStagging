...
class OLDocsPendingLayoutController extends Controller
{
	
	public function searchOLDocsPending(Request $request)
	{
	...
	public function resetsearchOLDocsPending(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeOLDocsPending(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/OnboardingReport/reloadmeoldocspending",compact('wid'));
	}
	
	
	public function expandOLDocsPending(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeOLDocsPending/'.$wid);
	}
	
	public function compressOLDocsPending(Request $request)
	{
		$wid = $request->wid;
	...
	public function candidateoldocsPendingLink(Request $request)
	{
		//echo "hello";exit;
		$dept = $request->dept;
		$wid = $request->wid;
