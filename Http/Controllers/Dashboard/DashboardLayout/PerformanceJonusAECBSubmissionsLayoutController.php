...
class PerformanceJonusAECBSubmissionsLayoutController extends Controller
{
	
	public function searchPerformanceJonusAECBSubmissions(Request $request)
	{
	...
	public function resetsearchPerformanceJonusAECBSubmissions(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmePerformanceJonusAECBSubmissions(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmePerformancejonusaecbsubmissions",compact('wid'));
	}
	
	
	public function expandPerformanceJonusAECBSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmePerformanceJonusAECBSubmissions/'.$wid);
	}
	
	public function compressPerformanceJonusAECBSubmissions(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'');
		return redirect('reloadmePerformanceJonusAECBSubmissions/'.$wid);
	}
	public function PerformanceJonusAECBSubmissionsByDate(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceJonusAECBSubmissionsByTeam(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceJonusAECBSubmissionsByProcessor(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterBYDate['.$widgetID.']','');	
	...
	public function PerformanceJonusAECBSubmissionsLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceJonusAECBSubmissionsLayoutByCM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function PerformanceJonusAECBSubmissionsLayoutByLM(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
		$request->session()->put('widgetFilterHiring['.$widgetID.'][data_type]','last_month');	
	...
	public function PerformanceJonusAECBSubmissionsLayoutBy3M(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
