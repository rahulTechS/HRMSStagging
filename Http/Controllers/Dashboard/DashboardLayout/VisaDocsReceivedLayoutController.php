...
class VisaDocsReceivedLayoutController extends Controller
{
	
	public function searchVisaDocsReceived(Request $request)
	{
	...
	public function resetsearchVisaDocsReceived(Request $request)
	{
		//echo "hello";exit;
	...
	public function reloadmeVisaDocsReceived(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/OnboardingReport/reloadmevisadocsreceived",compact('wid'));
	}
	
	
	public function expandVisaDocsReceived(Request $request)
	{
		$wid = $request->wid;
		$request->session()->put('open_section_status_'.$wid,'Yes');
		return redirect('reloadmeVisaDocsReceived/'.$wid);
	}
	
	public function compressVisaDocsReceived(Request $request)
	{
		$wid = $request->wid;
	...
	public function VisaDocsReceivedLastMonth(Request $request)
	{
		//echo "hello";exit;
		$widgetID = $request->wid;
	...
	public function candidateVisadocsReceivedLink(Request $request)
	{
		//echo "hello";exit;
		$dept = $request->dept;
		$wid = $request->wid;
	...
	public function candidateVisadocsReceivedTotelLink(Request $request)
	{
		//echo "hello";exit;
