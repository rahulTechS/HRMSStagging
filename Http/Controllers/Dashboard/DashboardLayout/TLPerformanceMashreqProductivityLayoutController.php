...
class TLPerformanceMashreqProductivityLayoutController extends Controller
{
	...
	public function reloadmeTLPerformanceMashreqProductivity(Request $request)
	{
		 $wid = $request->wid;
		
		return view("components/Performance/reloadmeTLPerformancemashreqProductivity",compact('wid'));
	}
	...
	public function expandTLPerformanceMashreqProductivity(Request $request)
	{
		...
		return redirect('reloadmeTLPerformanceMashreqProductivity/'.$wid);
	}
