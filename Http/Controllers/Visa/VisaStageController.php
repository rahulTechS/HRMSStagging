...
//print_r($visaStageList);exit;				
	...
	public function addVisaStagePostProcess(Request $req)
	{
		 ...
		 $visaStageModel->category = $visaStageData['category'];
		 $visaStageModel->stage_type = $visaStageData['stage_type'];
		 $visaStageModel->evisa = $visaStageData['evisa'];
		 $visaStageModel->status_change_stage = $visaStageData['status_change_stage'];
	...
	public function updateVisaStagePostProcess(Request $req)
	{
		 ...
		 $visaStageUpdate->category = $visaStageData['category'];
		 $visaStageUpdate->stage_type = $visaStageData['stage_type'];
		 $visaStageUpdate->evisa = $visaStageData['evisa'];
		 $visaStageUpdate->status_change_stage = $visaStageData['status_change_stage'];
		 if(isset($visaStageData['allow_upload']))
		 {
