...
class V4GeoLocationController extends Controller
{
...
public function GeoLocationSave(Request $request)
{
	$requestParameters = $request->input();
		...
		if(isset($requestParameters['empId']) && $requestParameters['empId'] != ''&& isset($requestParameters['Token']) && $requestParameters['Token'] != '' && isset($requestParameters['long']) && $requestParameters['long'] != '' && isset($requestParameters['lat']) && $requestParameters['lat'] != '')
		{
			$Token = $requestParameters['Token'];
			$empId = $requestParameters['empId'];
