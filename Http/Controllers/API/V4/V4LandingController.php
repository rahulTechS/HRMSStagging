...
class V4LandingController extends Controller
{
			...
			if($empData != '')
			{
				 ...
				 $result['RequestList'][0]['IconSelected'] = 'https://www.hr-suranigroup.com/hrm/img/mobile-icon/sales-management-active.png'; 
				  ...
				  $result['RequestList'][0]['DefaultSelected'] = false;
				     ...
				     $result['RequestList'][1]['Title'] = 'Add Sales'; 
				 $result['RequestList'][1]['Icon'] = 'https://www.hr-suranigroup.com/hrm/img/mobile-icon/add-submission.png'; 
				 $result['RequestList'][1]['IconSelected'] = 'https://www.hr-suranigroup.com/hrm/img/mobile-icon/add-submission-active.png'; 
				  $result['RequestList'][1]['identifier'] = 153; 
				   $result['RequestList'][1]['DefaultSelected'] = false;
				   
				     
				    $result['RequestList'][2]['Title'] = 'Cross Sales'; 
				 $result['RequestList'][2]['Icon'] = 'https://www.hr-suranigroup.com/hrm/img/mobile-icon/team-lead.png'; 
				 $result['RequestList'][2]['IconSelected'] = 'https://www.hr-suranigroup.com/hrm/img/mobile-icon/team-lead-active.png'; 
				  $result['RequestList'][2]['identifier'] = 160; 
