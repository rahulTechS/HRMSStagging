...
namespace App\Http\Controllers\CompareAttributes;
...
use App\Models\CompareAttributes\Attributes;
...
class AttributesController extends Controller
{
    ...
    public  function Index(Request $request)
	{
        ...
        return view("CompareAttributes/index",compact('empDetailsIndex','departmentLists','designationLists','tL_details'));
    }
    ...
    public static function addAttributesData(Request $request)
    {
        ...
        return view("CompareAttributes/addRequest",compact('cateDetails'));
    }

    public static function getRootCategoryContentData(Request $request)
    {
        $rowid=$request->rowid;
        // $empDetails='';
        ...
        return view("CompareAttributes/addRequestContent");

    }


    public function getTableRowstoAddAttribute(Request $request)
	{
	...
	return view("CompareAttributes/tableRowContent",compact('i'));

	}



    public function addNewAttributesRequestPostSubmit(Request $request)
    {
        if($request->attributesnew==NULL)
        {
            $counter=1;
        }
        else
        ...
        if($counter==1)
        {
            ...
            [
                'attribute1.required'=> 'Please Add Attribute',                 
            ]);
        }
        ...
        if($counter==2)
        {
            ...
            [			
                'attribute1' => 'required',
                'attribute2' => 'required_if:counter,2',              
            ],
            [
                'attribute1.required'=> 'Please Add Attribute',                
                'attribute2.required_if'=> 'Please Add Attribute',                  
            ]);
        }
        if($counter==3)
        {
            ...
            [			
                'attribute1' => 'required',
                'attribute2' => 'required_if:counter,3',
                'attribute3' => 'required_if:counter,3',             
            ],
            [
                'attribute1.required'=> 'Please Add Attribute',                
                'attribute2.required_if'=> 'Please Add Attribute',
                'attribute3.required_if'=> 'Please Add Attribute',                 
            ]);
        }
        if($counter==4)
        {
            ...
            [			
                'attribute1' => 'required',
                'attribute2' => 'required_if:counter,4',
                'attribute3' => 'required_if:counter,4', 
                'attribute4' => 'required_if:counter,4',             
            ],
            [
                'attribute1.required'=> 'Please Add Attribute',                
                'attribute2.required_if'=> 'Please Add Attribute',
                'attribute3.required_if'=> 'Please Add Attribute', 
                'attribute4.required_if'=> 'Please Add Attribute',                 
            ]);
        }
        ...
        if($counter==5)
        {
            ...
            [			
                'attribute1' => 'required',
                'attribute2' => 'required_if:counter,5',
                'attribute3' => 'required_if:counter,5', 
                'attribute4' => 'required_if:counter,5',  
                'attribute5' => 'required_if:counter,5',            
            ],
            [
                'attribute1.required'=> 'Please Add Attribute',                
                'attribute2.required_if'=> 'Please Add Attribute',
                'attribute3.required_if'=> 'Please Add Attribute', 
                'attribute4.required_if'=> 'Please Add Attribute',  
                'attribute5.required_if'=> 'Please Add Attribute',                 
            ]);
        }
        ...
        if($counter==6)
        {
            ...
            [			
                'attribute1' => 'required',
                'attribute2' => 'required_if:counter,6',
                'attribute3' => 'required_if:counter,6', 
                'attribute4' => 'required_if:counter,6',  
                'attribute5' => 'required_if:counter,6', 
                'attribute6' => 'required_if:counter,6',            
            ],
            [
                'attribute1.required'=> 'Please Add Attribute',                
                'attribute2.required_if'=> 'Please Add Attribute',
                ...
                'attribute4.required_if'=> 'Please Add Attribute',  
                'attribute5.required_if'=> 'Please Add Attribute', 
                'attribute6.required_if'=> 'Please Add Attribute',                 
            ]);
        }
		...
		else
		{
            ...
            //print_r (explode(",",$request->attributes));
            //echo $request->attributes;
            // print_r($attributesarr);
            
           // return $request->all();

            if($counter==1)
            {
                $advancedPayRequest = new Attributes();
                $advancedPayRequest->category_id = $request->addRequestEmp;
                $advancedPayRequest->attribute_name = $request->attribute1;
            ...
            {
                $attributesarr = explode(",",$request->attributesnew);
                $arr = array_filter($attributesarr);
                $attributesarr = implode(',', $arr);
                $attributesarr = explode(",",$attributesarr);               
                
                foreach ($attributesarr as $user)
                {
                    $user;
    
                    $advancedPayRequest = new Attributes();
                    $advancedPayRequest->category_id = $request->addRequestEmp;
                    $advancedPayRequest->attribute_name = $user;
                    $advancedPayRequest->created_at = date('Y-m-d H:i:s');
                    $advancedPayRequest->status = 1;
                    $advancedPayRequest->save();
                }
            ...
            return response()->json(['success'=>'Attributes Added Successfully.']);
        }
    }


    public function allAttributesListingData(Request $request)
    {
        $whereraw = '';
		$whereraw1 = '';
        ...
        else
        {
            if($empData==1) // all
            {
                $requestDetails = Attributes::groupBy('category_id')->orderBy('id', 'desc')
                //->toSql();	 
                //dd($documentCollectiondetails);						
                ->paginate($paginationValue);	
                
                $reportsCount = Attributes::groupBy('category_id')->orderBy('id','desc')
                ->get()->count();
        ...
        return view("CompareAttributes/listingAll",compact('requestDetails','paginationValue','reportsCount'));
    }
