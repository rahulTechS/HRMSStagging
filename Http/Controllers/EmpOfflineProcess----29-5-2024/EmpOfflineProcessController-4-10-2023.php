...
class EmpOfflineProcessController extends Controller
{
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('empoffboard_status_filter_list')) && $request->session()->get('empoffboard_status_filter_list') != 'All')
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = EmpOffline::whereRaw($whereraw)->where("condition_leaving",1)->paginate($paginationValue);
				...
				if($whereraw != '')
				{
					...
					$reportsCount = EmpOffline::where("condition_leaving",1)->whereRaw($whereraw)->get()->count();
				}
				else
				{
...
if(!empty($request->session()->get('ReasonofAttrition_empoffboard_filter_list')) && $request->session()->get('ReasonofAttrition_empoffboard_filter_list') != 'All')
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = EmpOffline::whereIn("condition_leaving",array(2,3))->whereRaw($whereraw)->orderBy("condition_leaving_date", "DESC")->paginate($paginationValue);
					//print_r($documentCollectiondetails);
				}
				else
				{
				...
				if($whereraw != '')
				{
					...
					$reportsCount = EmpOffline::whereIn("condition_leaving",array(2,3))->whereRaw($whereraw)->get()->count();
				}
				else
				{
...
if(!empty($request->session()->get('ReasonofAttrition_empoffboard_filter_list')) && $request->session()->get('ReasonofAttrition_empoffboard_filter_list') != 'All')
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = EmpOffline::where("condition_leaving",4)->whereRaw($whereraw)->orderBy("settelement_date", "DESC")->paginate($paginationValue);
				}
				else
				{
				...
				if($whereraw != '')
				{
					...
					$reportsCount = EmpOffline::where("condition_leaving",4)->whereRaw($whereraw)->get()->count();
				}
				else
				{
...
if(!empty($request->session()->get('ReasonofAttrition_empoffboard_filter_list')) && $request->session()->get('ReasonofAttrition_empoffboard_filter_list') != 'All')
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = EmpOffline::whereIn("condition_leaving",array(3,4,5,6))->whereRaw($whereraw)->orderBy("settelement_date", "DESC")->paginate($paginationValue);
				}
				else
				{
					
					$documentCollectiondetails = EmpOffline::whereIn("condition_leaving",array(3,4,5,6))->orderBy("settelement_date", "DESC")->paginate($paginationValue);
				...
				if($whereraw != '')
				{
					...
					$reportsCount = EmpOffline::whereIn("condition_leaving",array(3,4,5,6))->whereRaw($whereraw)->get()->count();
				}
				else
				{
					$reportsCount = EmpOffline::whereIn("condition_leaving",array(3,4,5,6))->get()->count();
...
public function searchOffBoardData(Request $request)
		...
		public static function getVintageData($empid = NULL)
	   {
			...
			$details=Employee_details::where("emp_id",$empid)->first();
