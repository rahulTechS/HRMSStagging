...
class TabsAjaxController extends Controller
{
	   ...
	   public function offBoardsummaryTabWithFullViewAjax(Request $request)
	   {
			...
			*/
			...
			if($documentCollectionDetails->condition_leaving == 3 || $documentCollectionDetails->condition_leaving == 2 || $documentCollectionDetails->condition_leaving==1 || $documentCollectionDetails->exit_interview_status>=1)
			{
			...
			if($documentCollectionDetails->condition_leaving == 3 || $documentCollectionDetails->condition_leaving == 2 || $documentCollectionDetails->condition_leaving==1 || $documentCollectionDetails->condition_leaving == 4 || $documentCollectionDetails->condition_leaving == 6 || $documentCollectionDetails->exit_interview_status>=1)
			{
...
if($documentCollectionDetails->condition_leaving == 3 || $documentCollectionDetails->condition_leaving == 2 || $documentCollectionDetails->condition_leaving==1 || $documentCollectionDetails->condition_leaving ==5 || $documentCollectionDetails->condition_leaving ==4 || $documentCollectionDetails->exit_interview_status>=1)
			{
