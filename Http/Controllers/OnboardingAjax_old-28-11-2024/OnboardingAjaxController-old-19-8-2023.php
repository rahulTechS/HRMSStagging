...
class OnboardingAjaxController extends Controller
{
       ...
       public function documentcollection(Request $req)
	   {
		...
		return view("OnboardingAjax/documentcollectionajax",compact('visastagearray','r_id','visastagestatuslist','jobOpning','jobRecruiterDetails','departmentLists','productDetails','designationDetails','filterList','salaryBreakUpdetails','departmentIdArray'));
	   }
