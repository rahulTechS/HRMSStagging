 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
		...
		public function requestdocmentdataPost(Request $request)
	   {
		...
		$parameters = $request->input(); 
			...
			$sheet->setCellValue('M'.$indexCounter, strtoupper('Visa Pipeline Status'))->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('N'.$indexCounter, strtoupper('Backout Status'))->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('O'.$indexCounter, strtoupper('OfferLetter Status'))->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('P'.$indexCounter, strtoupper('Visa Status'))->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('Q'.$indexCounter, strtoupper('Training Status'))->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			$sheet->setCellValue('S'.$indexCounter, strtoupper('proposed salary'))->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			$sheet->setCellValue('T'.$indexCounter, strtoupper('Backout Reason'))->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
			...
			foreach ($selectedId as $sid) {
				...
				$sheet->setCellValue('M'.$indexCounter, $pipline)->getStyle('M'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('N'.$indexCounter, $backout)->getStyle('N'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('O'.$indexCounter, $offerletter)->getStyle('O'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('P'.$indexCounter, $visaprocess)->getStyle('P'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('Q'.$indexCounter, $training)->getStyle('Q'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('R'.$indexCounter, $onboard)->getStyle('R'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('S'.$indexCounter, "AED ".$proposedsalary)->getStyle('S'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
				$sheet->setCellValue('T'.$indexCounter, $backoutData)->getStyle('T'.$indexCounter)->getAlignment()->setHorizontal('center')->setVertical('top');
 ...
 */			$whereraw1 = '';
		...
		$filterList['visa_process_status'] = '';
		 ...
		 $salaryBreakUpdetails =  SalaryBreakup::where("status",1)->orderBy("id","DESC")->get();
		return view("OnboardingAjax/listingPageonboardingvisainprocess-All",compact('CandidateRecruiterArray','companyvisaArray','VintageArray','departmentLists','productDetails','designationDetails','documentCollectiondetails','reportsCount','filterList','salaryBreakUpdetails','paginationValue','selectedFilter','CandidateNameArray','CandidateEmailArray','DesignationArray','OpeningArray','StatusArray','DepartmentArray'));
	   }
...
public function OfferLetterReleasedStatus(Request $request){
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
	...
	public function getEmpBackoutPopupData(Request $req)
	   ...
	   public function getEMPexpecteddateJoiningData(Request $req)
	   {
		...
		return view("OnboardingAjax/expecteddateofjoining",compact('docId'));
	   }
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
		 ...
		 $salaryBreakUpdetails =  SalaryBreakup::where("status",1)->orderBy("id","DESC")->get();
		return view("OnboardingAjax/listingPageonboardingNotification",compact('CandidateRecruiterArray','companyvisaArray','VintageArray','departmentLists','productDetails','designationDetails','documentCollectiondetails','reportsCount','filterList','salaryBreakUpdetails','paginationValue','selectedFilter','CandidateNameArray','CandidateEmailArray','DesignationArray','OpeningArray','StatusArray','DepartmentArray'));
	   }
		...
		public function listingPageonboardingVisainprocessStage1(Request $request)
	   {
		...
		$filterList['visa_process_status'] = '';
		 ...
		 $salaryBreakUpdetails =  SalaryBreakup::where("status",1)->orderBy("id","DESC")->get();
		return view("OnboardingAjax/listingPageonboardingvisainprocess-Stage1",compact('CandidateRecruiterArray','companyvisaArray','VintageArray','departmentLists','productDetails','designationDetails','documentCollectiondetails','reportsCount','filterList','salaryBreakUpdetails','paginationValue','selectedFilter','CandidateNameArray','CandidateEmailArray','DesignationArray','OpeningArray','StatusArray','DepartmentArray'));
	   }
	public function listingPageonboardingVisainprocessStage2(Request $request)
	   {
		...
		$filterList['visa_process_status'] = '';
		 ...
		 $salaryBreakUpdetails =  SalaryBreakup::where("status",1)->orderBy("id","DESC")->get();
		return view("OnboardingAjax/listingPageonboardingvisainprocess-Stage2",compact('CandidateRecruiterArray','companyvisaArray','VintageArray','departmentLists','productDetails','designationDetails','documentCollectiondetails','reportsCount','filterList','salaryBreakUpdetails','paginationValue','selectedFilter','CandidateNameArray','CandidateEmailArray','DesignationArray','OpeningArray','StatusArray','DepartmentArray'));
	   }
 ...
 */			$whereraw1 = '';
		...
		$filterList['visa_process_status'] = '';
		 ...
		 $salaryBreakUpdetails =  SalaryBreakup::where("status",1)->orderBy("id","DESC")->get();
		return view("OnboardingAjax/listingPageonboardingvisapending",compact('CandidateRecruiterArray','companyvisaArray','VintageArray','departmentLists','productDetails','designationDetails','documentCollectiondetails','reportsCount','filterList','salaryBreakUpdetails','paginationValue','selectedFilter','CandidateNameArray','CandidateEmailArray','DesignationArray','OpeningArray','StatusArray','DepartmentArray'));
	   }
	...
	public function getOfferletterFollowUpDate(Request $req)
	   ...
	   public function docContentFrmOfferletterFollowUpPost(Request $request){
		...
		public function listingPageonboardingofferletterfollowup(Request $request)
	   {
		   //$request->session()->put('company_RecruiterNameAll_filter_inner_list','');
		    $whereraw = '';
			$whereraw1 = '';
 ...
 if(!empty($request->session()->get('onboarding_department_filter')) && $request->session()->get('onboarding_department_filter') != '')
			...
			if(!empty($request->session()->get('onboading_page_limit')))
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = DocumentCollectionDetails::whereIn("offer_letter_followup_status",array(1,2))->where("backout_status",1)->whereRaw($whereraw)->paginate($paginationValue);
					
				}
				else
				{
					//echo "hello1";
					$documentCollectiondetails = DocumentCollectionDetails::whereIn("offer_letter_followup_status",array(1,2))->where("backout_status",1)->paginate($paginationValue);
				...
				if($whereraw != '')
				{
					...
					$reportsCount = DocumentCollectionDetails::whereRaw($whereraw)->whereIn("offer_letter_followup_status",array(1,2))->where("backout_status",1)->get()->count();
				}
				else
				{
					$reportsCount = DocumentCollectionDetails::whereIn("offer_letter_followup_status",array(1,2))->where("backout_status",1)->get()->count();
				}
				$documentCollectiondetails->setPath(config('app.url/listingPageonboardingofferletterfollowup'));
				
		
		 
		return view("OnboardingAjax/listingPageonboardingOfferletterFollowup",compact('CandidateRecruiterArray','companyvisaArray','VintageArray','documentCollectiondetails','reportsCount','filterList','paginationValue','selectedFilter','CandidateNameArray','CandidateEmailArray','DesignationArray','OpeningArray','StatusArray','DepartmentArray'));
	   }
...
public static function getGrossSalaryMOL($id){
		$documentValues = DocumentCollectionDetailsValues::where("document_collection_id",$id)->where("attribute_code",132)->first();
		   if($documentValues !='' && $documentValues !=NULL)
		   { 
