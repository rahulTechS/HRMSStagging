...
class TabsAjaxController extends Controller
{
	   ...
	   public function warningLettersummaryTabWithFullViewAjax(Request $request)
	   {
			...
			$warningLetterdetails = WarningLetterRequest::where("emp_id",$empId)->orderBy('id','DESC')->first();
			...
			*/
			...
			if($warningLetterdetails)
			{
				...
				$stepsAll[0]['name'] = 'First Warning Letter'; 
			if($reqstatus == 1)
			{
			...
			else
			{
				...
				$OnboardingProgress = 'First Warning Letter';
				$stepsAll[0]['Tab'] = 'active'; 
			}
			...
			/*Step1*/
				...
				/*Step2*/
					$stepsAll[1]['name'] = 'Second Warning Letter'; 
					if($reqstatus == 2)
					{
					...
					$OnboardingProgress = 'Second Warning Letter';
					$stepsAll[1]['Tab'] = 'active';
					}
					else 
					{
					...
					/*Step3*/
					$stepsAll[2]['name'] = 'Third Warning Letter'; 
					if($reqstatus==3)
					{
					...
					else if($reqstatus>3)
					{
						...
						$OnboardingProgress = 'Third Warning Letter';
						$stepsAll[2]['Tab'] = 'active';
					}
					else 
					{
	   ...
	   public function offBoardtab2EmpDetailsAjax(Request $request)
	   {
		...
		// 	$empdata = ChangeSalary::where("emp_id",$empId)->orderBy('id','DESC')->first();
			...
			->orderBy('warning_letter_requests.id', 'desc')->first();
			 ...
			 return view("EmployeePerformanceReview/RequestTabsAjax/ConditionforLeaving",compact('documentCollectionDetails')); 
	   }
		...
		->orderBy('warning_letter_requests.id', 'desc')->first();
			 ...
			 return view("EmployeePerformanceReview/RequestTabsAjax/ExitInterview",compact('documentCollectionDetails')); 
			  }
		  ...
		  public function onBoardtab4EmpDetailsAjax(Request $request)
			{
				...
				->orderBy('warning_letter_requests.id', 'desc')->first();
			 	...
			 	return view("EmployeePerformanceReview/RequestTabsAjax/ExitInterview22",compact('documentCollectionDetails')); 
