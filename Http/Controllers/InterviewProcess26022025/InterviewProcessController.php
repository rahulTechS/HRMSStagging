...
class InterviewProcessController extends Controller
{
    public function InterviewProcess()
	{
		...
		$jobRecruiterDetails=RecruiterDetails::where("status",1)->whereNotIn('offline_status', [2])->get();
	...
	public function UpdateInterviewForm($rowId=NULL)
	{
		...
		$design=Designation::where("tlsm",2)->where("status",1)->get();
				...
				$empdetailsdata = Employee_details::whereIn("designation_by_doc_collection",$designarray)->whereNotIn('offline_status', [2])->get();
