...
class TabsAjaxController extends Controller
{
	   ...
	   public function offBoardsummaryTabWithFullViewAjax(Request $request)
	   {
			...
			*/
			...
			if($changesalarydetails)
			{
					...
					/*Step3*/
					$stepsAll[2]['name'] = 'Increment Letter'; 
					if($changesalarydetails->approvedrejectstatus==1 && $changesalarydetails->incrementstatus==0 && ($changesalarydetails->request_type==1 || $changesalarydetails->request_type==3))
					{
					...
					else if($changesalarydetails->incrementstatus==1 || $changesalarydetails->incrementstatus==2)
					{
						...
						$OnboardingProgress = 'Increment Letter';
						$stepsAll[2]['Tab'] = 'active';
					}
					else 
					{
	  ...
	  $Question='';
			 ...
			 return view("ChangeSalaryNew/RequestTabsAjax/ExitInterview",compact('documentCollectionDetails','Question','empdata','salrychnageinfo','rowid')); 
			  }
	...
	public function tabCancelvisaProcessPanelAjax(Request $request)
	{
		...
		return view("ChangeSalaryNew/RequestTabsAjax/tabvisaProcessPanelAjax",compact('documentCollectionDetails','totalCost','percentage','lastStageCompleted','visaStageD','totalDays','visaStageLists','visaTypeId','rowid'));
	}		  
