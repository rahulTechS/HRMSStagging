<?php
namespace App\Http\Controllers\ChangeSalary;
...
class EmpChangeSalaryController extends Controller
{
	...
	public function viewEmployeeProfile($empid=NULL)
	{
		...
		{			
			...
			return view("ChangeSalary/ChangeSalaryProcess",compact('Designation','empId','EmpName','design','jobfun','recdata'));
		...
		public function AjaxEmpList(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("offline_status",1)->paginate($paginationValue);
				$reportsCount = Employee_details::whereRaw($whereraw)->where("offline_status",1)->get()->count();
					$activeCount = Employee_details::whereRaw($whereraw)->where("offline_status",1)->where('status',1)->get()->count();
					$inactiveCount = Employee_details::whereRaw($whereraw)->where("offline_status",1)->where('status',2)->get()->count();				
				}
				else
				{
					$empdetails = Employee_details::orderBy("id","DESC")->where("offline_status",1)->paginate($paginationValue);
					$reportsCount = Employee_details::where("offline_status",1)->get()->count();	
					$activeCount = Employee_details::where('status',1)->where("offline_status",1)->get()->count();
					$inactiveCount = Employee_details::where('status',2)->where("offline_status",1)->get()->count();					
				}
			...
			return view("ChangeSalary/empList",compact('empdetails','paginationValue','departmentLists','deptID','reportsCount','activeCount','inactiveCount'));
		}
	...
	public function workLocationEMP(Request $req){
		 ...
		 if(count($Collection)>0)
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",9)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",9)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
			...
			return view("EmpProcess/AjaxEmpListenbd",compact('empdetails','paginationValue','departmentLists','deptID','reportsCountenbd','activeCountenbd','inactiveCountenbd'));
		}
		public function AjaxEmpListdeem(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",8)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",8)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
			...
			return view("EmpProcess/AjaxEmpListdeem",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountdeem','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountdeem','inactiveCountdeem'));
		}
		public function AjaxEmpListmashreq(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",36)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",36)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
		...
		public function AjaxEmpListaafaq(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",43)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",43)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
					$reportsCountaafaq = Employee_details::where("dept_id",43)->where("offline_status",1)->get()->count();	
					$activeCountaafaq = Employee_details::where("dept_id",43)->where("offline_status",1)->where('status',1)->get()->count();
					$inactiveCountaafaq = Employee_details::where("dept_id",43)->where("offline_status",1)->where('status',2)->get()->count();					
				}
			...
			return view("EmpProcess/AjaxEmpListaafaqList",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountaafaq','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountaafaq','inactiveCountaafaq'));
		}		
	...
	public function AjaxEmpListDIBData(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",46)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",46)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
			...
			return view("EmpProcess/AjaxEmpListDIB",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountdib','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountdib','inactiveCountdib'));
		}
//SCB
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",47)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",47)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
			...
			return view("EmpProcess/AjaxEmpListSCB",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountscb','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountscb','inactiveCountscb'));
		}
	...
	public function AjaxEmpListCBDData(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",49)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",49)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
			...
			return view("EmpProcess/AjaxEmpListCBD",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountcbd','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountcbd','inactiveCountcbd'));
		}
		...
		$deptID = '';
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				*/
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("offline_status",2)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::orderBy("id","DESC")->where("offline_status",2)->paginate($paginationValue);
	...
	public static function getTeamLeader($id = NULL)
	   ...
	   public function AjaxEmpListDUCData(Request $request){
			...
			if(!empty($request->session()->get('offset_emp_filter')))
				...
				if($whereraw != '')
				{
				$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",23)->where("offline_status",1)->paginate($paginationValue);
				...
				{
					$empdetails = Employee_details::where("dept_id",23)->where("offline_status",1)->orderBy("id","DESC")->paginate($paginationValue);
			...
			return view("EmpProcess/AjaxEmpListDUC",compact('empdetails','paginationValue','reportsCountduc','activeCountduc','inactiveCountduc'));
		}



		public function createSalaryChangeRequest(Request $request)
		{
			//return $request->all();
			...
			else
			{
				...
				$changesalaryRequest->emp_name = $request->fname;
		...
		public function EmpListIncrement(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('offset_emp_filter')))
				{
				...
				if($whereraw != '')
				{
					$empdetails = Employee_details::where("offline_status",1)
					...
					->orderBy('employee_details.id', 'desc')->paginate($paginationValue);
					//$empdetails = Employee_details::orderBy("id","DESC")->whereRaw($whereraw)->where("dept_id",9)->where("offline_status",1)->get();
				...
				// $empdetails = Employee_details::orderBy("id","DESC")->where("dept_id",9)->where("offline_status",1)->get();
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/empLIstIncrement'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("ChangeSalary/empLIstIncrement",compact('empdetails','paginationValue','departmentLists','deptID','reportsCountenbd','activeCountenbd','inactiveCountenbd'));
		}
		...
		public function EmpListMol(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('offset_emp_filter')))
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/empLIstMol'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("ChangeSalary/empLIstMol",compact('empdetails','paginationValue','departmentLists','deptID','reportsCountenbd','activeCountenbd','inactiveCountenbd'));
		}
}
