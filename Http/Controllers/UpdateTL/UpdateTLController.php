...
namespace App\Http\Controllers\UpdateTL;
...
class UpdateTLController extends Controller
{
       ...
       public function UpdateTLList(Request $request)
		{			
			...
			$empId=Employee_details::whereNull('tl_id')->where("job_function",2)->where("offline_status",1)->get();
			$EmpName=Employee_details::whereNull('tl_id')->where("job_function",2)->where("offline_status",1)->get();
			...
			return view("UpdateTL/UpdateTL",compact('Designation','empId','EmpName','design','jobfun','recdata'));
	   		...
	   		public function UpdateTLEmpList(Request $request){
			...
			$empdetails->setPath(config('app.url/UpdateTLEmpList'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("UpdateTL/UpdateTLList",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCount','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCount','inactiveCount'));
		}
		public function updateUpdateTLData(Request $request){
		$rowId=$request->rowId;
		...
		return view("UpdateTL/UpdateTLFormUpdate",compact('empLists','tL_details'));
		
	}
	public function updateUpdateTLDataDataPost(Request $req)
		{
			$inputData = $req->input();
		/* 	echo '<pre>';
			print_r($inputData);
		...
		public function searchbyempNameUpdateTL(Request $request)
		{
		...
		public function empFilterresetUpdateTL(Request $request)
		{
...
public function OfferLetterReleasedStatus(Request $request){
	...
	public function updatevisaLedgerDataPost(Request $req)
		...
		public function listingUpdateTLListENBDTL(Request $request){
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListENBDTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("UpdateTL/listingUpdateTLListENBDTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountenbd','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountenbd','inactiveCountenbd'));
		}
		public function listingUpdateTLListdeemTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListdeemTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("UpdateTL/listingUpdateTLListdeemTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountdeem','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountdeem','inactiveCountdeem'));
		}
		public function listingUpdateTLListmashreqTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined" )
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListmashreqTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
		...
		public function listingUpdateTLListaafaqTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListaafaqTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
		...
		public function listingUpdateTLListdibTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListdibTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("UpdateTL/listingUpdateTLListdibTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountdib','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountdib','inactiveCountdib'));
		}
		public function listingUpdateTLListscbTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListscbTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("UpdateTL/listingUpdateTLListscbTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountscb','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountscb','inactiveCountscb'));
		}
		public function listingUpdateTLListcbdTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			$departmentLists = Department::where("status",1)->orderBy('id','DESC')->get();
			$empdetails->setPath(config('app.url/listingUpdateTLListcbdTL'));
			Cache::put('empdetails', $empdetails, now()->addMinutes(30));
			
			return view("UpdateTL/listingUpdateTLListcbdTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCountcbd','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCountcbd','inactiveCountcbd'));
		}
		...
		public function listingUpdateTLListeibTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			return view("UpdateTL/listingUpdateTLListeibTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCounteib','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCounteib','inactiveCounteib'));
		}
		public function listingUpdateTLListhsbcTL(Request $request){
			//$request->session()->put('design_emp_filter_inner_list','');
			$deptID = '';
			if(!empty($request->session()->get('onboading_page_limitall')) && $request->session()->get('onboading_page_limitall')!="undefined")
				{
			...
			return view("UpdateTL/listingUpdateTLListhsbcTL",compact('VisaUnderCompany','LocationArray','VintageArray','empdetails','paginationValue','departmentLists','deptID','reportsCounthsbc','empIdArray','selectedFilter','f_nameArray','l_nameArray','departmentArray','sourcecodeArray','designationArray','activeCounthsbc','inactiveCounthsbc'));
		}
