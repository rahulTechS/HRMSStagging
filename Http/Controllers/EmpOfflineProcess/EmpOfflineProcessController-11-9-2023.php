...
if(!empty($request->session()->get('ReasonofAttrition_empoffboard_filter_list')) && $request->session()->get('ReasonofAttrition_empoffboard_filter_list') != 'All')
				...
				if($whereraw != '')
				{
					...
					$documentCollectiondetails = EmpOffline::whereIn("condition_leaving",array(3,4))->whereRaw($whereraw)->orderBy("exit_interview_date", "DESC")->paginate($paginationValue);
				}
				else
				{
...
if(!empty($request->session()->get('ReasonofAttrition_empoffboard_filter_list')) && $request->session()->get('ReasonofAttrition_empoffboard_filter_list') != 'All')
				...
				{
					//echo "hello";exit;
					$documentCollectiondetails = EmpOffline::whereIn("condition_leaving",array(3,4))->whereRaw($whereraw)->orderBy("settelement_date", "DESC")->paginate($paginationValue);
				}
				else
				{
				...
				if($whereraw != '')
				{
					...
					$reportsCount = EmpOffline::whereIn("condition_leaving",array(3,4))->whereRaw($whereraw)->get()->count();
				}
				else
				{
					$reportsCount = EmpOffline::whereIn("condition_leaving",array(3,4))->get()->count();
