					...
					if(!empty($sheetData))
					{
						for($k=0;$k<count($sheetData);$k++)
						{
							...
							*/							
							...
							$whereRaw = "application_number ='".$application_number."'";
							...
							{			
								...
								// }
								DB::table('EIB_bank_mis')->where('application_number', $application_number)->update($file_values);
							...
							else
							{
								...
								$all_values['application_number'] = $application_number;
