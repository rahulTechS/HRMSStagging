...
class ReportingController extends Controller
{
			...
			public static function getEndCountTab($tlId,$fromDate,$toDate)
			{
				...
				return  EnbdTabResultProcess::where("close_month",$closeData)->where("tl_id",$tlId)->where("location","DUBAI")->distinct('app_id')->count();
			...
			public static function getWipCountTab($tlId,$fromDate,$toDate)
			{
				...
				echo $toDate;
				exit; */
				return  EnbdTabResultProcess::where("tl_id",$tlId)->where("status_id_bank",7)->distinct('app_id')->count();
			...
			public static function getCancelCountTab($tlId,$fromDate,$toDate)
			{
				...
				return MainMisReport::whereDate("submission_format",">=",$fromDate)->whereDate("submission_format","<=",$toDate)->where("TL",$tlId)->where("approved_notapproved",2)->get()->count();
			}
			...
			public static function getRejectedCountTab($tlId,$fromDate,$toDate)
			{
				...
				return MainMisReport::whereDate("submission_format",">=",$fromDate)->whereDate("submission_format","<=",$toDate)->where("TL",$tlId)->where("approved_notapproved",5)->get()->count();
			}
			...
			public static function getEndCountSE($SEId,$tlId,$fromDate,$toDate)
			{
				...
				echo $toDate;
				exit; */
				return  EndJonusEnbdCardsSubmission::whereDate("action_date",">=",$fromDate)->whereDate("action_date","<=",$toDate)->where("se_id",$SEId)->where("tl_id",$tlId)->where("location","DUBAI")->distinct('app_id')->count();
			...
			public static function getEndCountSETab($SEId,$tlId,$fromDate,$toDate)
			{
				...
				exit; */
				$closeData = date("M Y",strtotime($toDate));
				return  EnbdTabResultProcess::where("close_month",$closeData)->where("tl_id",$tlId)->where("se_id",$SEId)->where("location","DUBAI")->distinct('app_id')->count();
			...
			public static function getWipCountSE($SEId,$tlId,$fromDate,$toDate)
			{
				...
				echo $toDate;
				exit; */
				return  WipJonusEnbdCardsSubmission::where("se_id",$SEId)->where("tl_id",$tlId)->where("show_status",1)->where("location","DUBAI")->distinct('app_id')->count();
			...
			public static function getWipCountSETab($SEId,$tlId,$fromDate,$toDate)
			{
				...
				return  EnbdTabResultProcess::where("se_id",$SEId)->where("tl_id",$tlId)->where("status_id_bank",7)->distinct('app_id')->count();
			}
			public static function getCancelCountSE($SEId,$tlId,$fromDate,$toDate)
			{
				...
				echo $toDate;
				exit; */
				return  CancelJonusEnbdCardsSubmission::whereDate("action_date",">=",$fromDate)->whereDate("action_date","<=",$toDate)->where("se_id",$SEId)->where("tl_id",$tlId)->where("location","DUBAI")->distinct('app_id')->count();
			...
			public static function getCancelCountSETab($SEId,$tlId,$fromDate,$toDate)
			{
				...
				return MainMisReport::whereDate("submission_format",">=",$fromDate)->whereDate("submission_format","<=",$toDate)->where("employee_id",$SEId)->where("TL",$tlId)->where("approved_notapproved",2)->get()->count();
			}
			public static function getRejectedCountSE($SEId,$tlId,$fromDate,$toDate)
			{
				...
				echo $toDate;
				exit; */
				return  RejectedJonusEnbdCardsSubmission::whereDate("action_date",">=",$fromDate)->whereDate("action_date","<=",$toDate)->where("se_id",$SEId)->where("tl_id",$tlId)->where("location","DUBAI")->distinct('app_id')->count();
			...
			public static function getRejectedCountSETab($SEId,$tlId,$fromDate,$toDate)
			{
				...
				return MainMisReport::whereDate("submission_format",">=",$fromDate)->whereDate("submission_format","<=",$toDate)->where("employee_id",$SEId)->where("TL",$tlId)->where("approved_notapproved",5)->get()->count();
			}
